...
from mcp_server_buildium.buildium_sdk.models.application_charge_post_message import ApplicationChargePostMessage
from mcp_server_buildium.buildium_sdk.models.application_charge_put_message import ApplicationChargePutMessage
...
from mcp_server_buildium.buildium_sdk.models.application_payment_post_message import ApplicationPaymentPostMessage
from mcp_server_buildium.buildium_sdk.models.application_payment_put_message import ApplicationPaymentPutMessage
from mcp_server_buildium.buildium_sdk.models.application_refund_message import ApplicationRefundMessage
from mcp_server_buildium.buildium_sdk.models.application_refund_post_message import ApplicationRefundPostMessage
from mcp_server_buildium.buildium_sdk.models.application_reverse_payment_post_message import ApplicationReversePaymentPostMessage
from mcp_server_buildium.buildium_sdk.models.application_transaction_message import ApplicationTransactionMessage
...
class ApplicationTransactionsApi:
    ...
    @validate_call
    async def external_api_application_ledger_auto_allocated_payments_create_application_auto_allocated_payment(
        self,
        application_id: Annotated[StrictInt, Field(description="The application unique identifier.")],
        application_auto_allocated_payment_post_message: ApplicationAutoAllocatedPaymentPostMessage,
        ...
        :param application_id: The application unique identifier. (required)
        :type application_id: int
        :param application_auto_allocated_payment_post_message: (required)
        :type application_auto_allocated_payment_post_message: ApplicationAutoAllocatedPaymentPostMessage
        ...
        _param = self._external_api_application_ledger_auto_allocated_payments_create_application_auto_allocated_payment_serialize(
            application_id=application_id,
            application_auto_allocated_payment_post_message=application_auto_allocated_payment_post_message,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "ApplicationTransactionMessage",
    ...
    @validate_call
    async def external_api_application_ledger_auto_allocated_payments_create_application_auto_allocated_payment_with_http_info(
        self,
        application_id: Annotated[StrictInt, Field(description="The application unique identifier.")],
        application_auto_allocated_payment_post_message: ApplicationAutoAllocatedPaymentPostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApplicationTransactionMessage]:
        """Create a payment (auto allocated)
    ...
    @validate_call
    async def external_api_application_ledger_auto_allocated_payments_create_application_auto_allocated_payment_without_preload_content(
        self,
        application_id: Annotated[StrictInt, Field(description="The application unique identifier.")],
        application_auto_allocated_payment_post_message: ApplicationAutoAllocatedPaymentPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_application_ledger_auto_allocated_payments_create_application_auto_allocated_payment_serialize(
        self,
        application_id,
        application_auto_allocated_payment_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if application_auto_allocated_payment_post_message is not None:
            _body_params = application_auto_allocated_payment_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/applications/{applicationId}/autoallocatedpayments',
    ...
    @validate_call
    async def external_api_application_ledger_charges_create_application_ledger_charge(
        self,
        application_id: StrictInt,
        application_charge_post_message: ApplicationChargePostMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type application_id: int
        :param application_charge_post_message: (required)
        :type application_charge_post_message: ApplicationChargePostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_application_ledger_charges_create_application_ledger_charge_serialize(
            application_id=application_id,
            application_charge_post_message=application_charge_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_application_ledger_charges_create_application_ledger_charge_with_http_info(
        self,
        application_id: StrictInt,
        application_charge_post_message: ApplicationChargePostMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_application_ledger_charges_create_application_ledger_charge_without_preload_content(
        self,
        application_id: StrictInt,
        application_charge_post_message: ApplicationChargePostMessage,
        _request_timeout: Union[
    ...
    def _external_api_application_ledger_charges_create_application_ledger_charge_serialize(
        self,
        application_id,
        application_charge_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if application_charge_post_message is not None:
            _body_params = application_charge_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/applications/{applicationId}/charges',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_application_ledger_charges_get_application_charges(
        self,
        application_id: StrictInt,
        chargeids: Annotated[Optional[List[StrictInt]], Field(description="Filters results by charge ids")] = None,
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any application transaction whose start date is greater than or equal to the specified value.")] = None,
        transactiondateto: Annotated[Optional[date], Field(description="Filters results to any application transaction whose end date is less than or equal to the specified value.")] = None,
        ...
        :param application_id: (required)
        :type application_id: int
        :param chargeids: Filters results by charge ids
        :type chargeids: List[int]
        :param transactiondatefrom: Filters results to any application transaction whose start date is greater than or equal to the specified value.
        :type transactiondatefrom: date
        :param transactiondateto: Filters results to any application transaction whose end date is less than or equal to the specified value.
        ...
        _param = self._external_api_application_ledger_charges_get_application_charges_serialize(
            application_id=application_id,
            chargeids=chargeids,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ApplicationChargeMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_application_ledger_charges_get_application_charges_with_http_info(
        self,
        application_id: StrictInt,
        chargeids: Annotated[Optional[List[StrictInt]], Field(description="Filters results by charge ids")] = None,
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any application transaction whose start date is greater than or equal to the specified value.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ApplicationChargeMessage]]:
        """Retrieve all charges
    ...
    @validate_call
    async def external_api_application_ledger_charges_get_application_charges_without_preload_content(
        self,
        application_id: StrictInt,
        chargeids: Annotated[Optional[List[StrictInt]], Field(description="Filters results by charge ids")] = None,
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any application transaction whose start date is greater than or equal to the specified value.")] = None,
    ...
    def _external_api_application_ledger_charges_get_application_charges_serialize(
        self,
        application_id,
        chargeids,
        transactiondatefrom,
        ...
        if application_id is not None:
            _path_params['applicationId'] = application_id
        # process the query parameters
        if chargeids is not None:
            
            _query_params.append(('chargeids', chargeids))
    ...
    @validate_call
    async def external_api_application_ledger_charges_get_application_ledger_charge_by_id(
        self,
        application_id: StrictInt,
        ...
        _param = self._external_api_application_ledger_charges_get_application_ledger_charge_by_id_serialize(
            application_id=application_id,
    ...
    @validate_call
    async def external_api_application_ledger_charges_get_application_ledger_charge_by_id_with_http_info(
        self,
        application_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApplicationChargeMessage]:
        """Retrieve a charge
    ...
    @validate_call
    async def external_api_application_ledger_charges_get_application_ledger_charge_by_id_without_preload_content(
        self,
        application_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_application_ledger_charges_get_application_ledger_charge_by_id_serialize(
        self,
        application_id,
        transaction_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/applications/{applicationId}/charges/{transactionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_application_ledger_charges_update_application_ledger_charge(
        self,
        application_id: StrictInt,
        transaction_id: StrictInt,
        application_charge_put_message: ApplicationChargePutMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param transaction_id: (required)
        :type transaction_id: int
        :param application_charge_put_message: (required)
        :type application_charge_put_message: ApplicationChargePutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_application_ledger_charges_update_application_ledger_charge_serialize(
            application_id=application_id,
            transaction_id=transaction_id,
            application_charge_put_message=application_charge_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ApplicationTransactionMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_application_ledger_charges_update_application_ledger_charge_with_http_info(
        self,
        application_id: StrictInt,
        transaction_id: StrictInt,
        application_charge_put_message: ApplicationChargePutMessage,
    ...
    @validate_call
    async def external_api_application_ledger_charges_update_application_ledger_charge_without_preload_content(
        self,
        application_id: StrictInt,
        transaction_id: StrictInt,
        application_charge_put_message: ApplicationChargePutMessage,
    ...
    def _external_api_application_ledger_charges_update_application_ledger_charge_serialize(
        self,
        application_id,
        transaction_id,
        application_charge_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if application_charge_put_message is not None:
            _body_params = application_charge_put_message
    ...
    @validate_call
    async def external_api_application_ledger_payment_reversals_create_application_ledger_reverse_payment(
        self,
        application_id: Annotated[StrictInt, Field(description="The application unique identifier.")],
        application_reverse_payment_post_message: ApplicationReversePaymentPostMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param application_id: The application unique identifier. (required)
        :type application_id: int
        :param application_reverse_payment_post_message: (required)
        :type application_reverse_payment_post_message: ApplicationReversePaymentPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_application_ledger_payment_reversals_create_application_ledger_reverse_payment_serialize(
            application_id=application_id,
            application_reverse_payment_post_message=application_reverse_payment_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_application_ledger_payment_reversals_create_application_ledger_reverse_payment_with_http_info(
        self,
        application_id: Annotated[StrictInt, Field(description="The application unique identifier.")],
        application_reverse_payment_post_message: ApplicationReversePaymentPostMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_application_ledger_payment_reversals_create_application_ledger_reverse_payment_without_preload_content(
        self,
        application_id: Annotated[StrictInt, Field(description="The application unique identifier.")],
        application_reverse_payment_post_message: ApplicationReversePaymentPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_application_ledger_payment_reversals_create_application_ledger_reverse_payment_serialize(
        self,
        application_id,
        application_reverse_payment_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if application_reverse_payment_post_message is not None:
            _body_params = application_reverse_payment_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/applications/{applicationId}/reversepayments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_application_ledger_payments_create_application_ledger_payment(
        self,
        application_id: Annotated[StrictInt, Field(description="The application unique identifier.")],
        application_payment_post_message: ApplicationPaymentPostMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param application_id: The application unique identifier. (required)
        :type application_id: int
        :param application_payment_post_message: (required)
        :type application_payment_post_message: ApplicationPaymentPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_application_ledger_payments_create_application_ledger_payment_serialize(
            application_id=application_id,
            application_payment_post_message=application_payment_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_application_ledger_payments_create_application_ledger_payment_with_http_info(
        self,
        application_id: Annotated[StrictInt, Field(description="The application unique identifier.")],
        application_payment_post_message: ApplicationPaymentPostMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_application_ledger_payments_create_application_ledger_payment_without_preload_content(
        self,
        application_id: Annotated[StrictInt, Field(description="The application unique identifier.")],
        application_payment_post_message: ApplicationPaymentPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_application_ledger_payments_create_application_ledger_payment_serialize(
        self,
        application_id,
        application_payment_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if application_payment_post_message is not None:
            _body_params = application_payment_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/applications/{applicationId}/payments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_application_ledger_payments_update_application_ledger_payment(
        self,
        application_id: Annotated[StrictInt, Field(description="The application unique identifier.")],
        transaction_id: StrictInt,
        application_payment_put_message: ApplicationPaymentPutMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param transaction_id: (required)
        :type transaction_id: int
        :param application_payment_put_message: (required)
        :type application_payment_put_message: ApplicationPaymentPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_application_ledger_payments_update_application_ledger_payment_serialize(
            application_id=application_id,
            transaction_id=transaction_id,
            application_payment_put_message=application_payment_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_application_ledger_payments_update_application_ledger_payment_with_http_info(
        self,
        application_id: Annotated[StrictInt, Field(description="The application unique identifier.")],
        transaction_id: StrictInt,
        application_payment_put_message: ApplicationPaymentPutMessage,
    ...
    @validate_call
    async def external_api_application_ledger_payments_update_application_ledger_payment_without_preload_content(
        self,
        application_id: Annotated[StrictInt, Field(description="The application unique identifier.")],
        transaction_id: StrictInt,
        application_payment_put_message: ApplicationPaymentPutMessage,
    ...
    def _external_api_application_ledger_payments_update_application_ledger_payment_serialize(
        self,
        application_id,
        transaction_id,
        application_payment_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if application_payment_put_message is not None:
            _body_params = application_payment_put_message
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/applications/{applicationId}/payments/{transactionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_application_ledger_refunds_create_application_ledger_refund(
        self,
        application_id: StrictInt,
        application_refund_post_message: ApplicationRefundPostMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param application_id: (required)
        :type application_id: int
        :param application_refund_post_message: (required)
        :type application_refund_post_message: ApplicationRefundPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_application_ledger_refunds_create_application_ledger_refund_serialize(
            application_id=application_id,
            application_refund_post_message=application_refund_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_application_ledger_refunds_create_application_ledger_refund_with_http_info(
        self,
        application_id: StrictInt,
        application_refund_post_message: ApplicationRefundPostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ApplicationRefundMessage]:
        """Create a refund
    ...
    @validate_call
    async def external_api_application_ledger_refunds_create_application_ledger_refund_without_preload_content(
        self,
        application_id: StrictInt,
        application_refund_post_message: ApplicationRefundPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_application_ledger_refunds_create_application_ledger_refund_serialize(
        self,
        application_id,
        application_refund_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if application_refund_post_message is not None:
            _body_params = application_refund_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/applications/{applicationId}/refunds',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_application_ledger_refunds_get_application_ledger_refund_by_id(
        self,
        application_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_application_ledger_refunds_get_application_ledger_refund_by_id_serialize(
            application_id=application_id,
            transaction_id=transaction_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def external_api_application_ledger_refunds_get_application_ledger_refund_by_id_with_http_info(
        self,
        application_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_application_ledger_refunds_get_application_ledger_refund_by_id_without_preload_content(
        self,
        application_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_application_ledger_refunds_get_application_ledger_refund_by_id_serialize(
        self,
        application_id,
        transaction_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/applications/{applicationId}/refunds/{transactionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_application_ledger_transactions_get_application_transactions(
        self,
        application_id: StrictInt,
        ids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to specific transactions by their unique identifiers.  If not specified, all application transactions will be returned.")] = None,
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any application transaction whose start date is greater than or equal to the specified value.  The date must be formatted as YYYY-MM-DD")] = None,
        transactiondateto: Annotated[Optional[date], Field(description="Filters results to any application transaction whose end date is less than or equal to the specified value.  The date must be formatted as YYYY-MM-DD")] = None,
        transactiontypes: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any application transaction whose application transaction type matches the specified types.  If no type is specified, application transactions with any type will be returned.")] = None,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[ApplicationTransactionMessage]:
        ...
        :param application_id: (required)
        :type application_id: int
        :param ids: Filters results to specific transactions by their unique identifiers.  If not specified, all application transactions will be returned.
        :type ids: List[int]
        :param transactiondatefrom: Filters results to any application transaction whose start date is greater than or equal to the specified value.  The date must be formatted as YYYY-MM-DD
        :type transactiondatefrom: date
        :param transactiondateto: Filters results to any application transaction whose end date is less than or equal to the specified value.  The date must be formatted as YYYY-MM-DD
        :type transactiondateto: date
        :param transactiontypes: Filters results to any application transaction whose application transaction type matches the specified types.  If no type is specified, application transactions with any type will be returned.
        ...
        _param = self._external_api_application_ledger_transactions_get_application_transactions_serialize(
            application_id=application_id,
            ids=ids,
            transactiondatefrom=transactiondatefrom,
            transactiondateto=transactiondateto,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ApplicationTransactionMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_application_ledger_transactions_get_application_transactions_with_http_info(
        self,
        application_id: StrictInt,
        ids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to specific transactions by their unique identifiers.  If not specified, all application transactions will be returned.")] = None,
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any application transaction whose start date is greater than or equal to the specified value.  The date must be formatted as YYYY-MM-DD")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ApplicationTransactionMessage]]:
        """Retrieve all application transactions
    ...
    @validate_call
    async def external_api_application_ledger_transactions_get_application_transactions_without_preload_content(
        self,
        application_id: StrictInt,
        ids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to specific transactions by their unique identifiers.  If not specified, all application transactions will be returned.")] = None,
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any application transaction whose start date is greater than or equal to the specified value.  The date must be formatted as YYYY-MM-DD")] = None,
    ...
    def _external_api_application_ledger_transactions_get_application_transactions_serialize(
        self,
        application_id,
        ids,
        transactiondatefrom,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/applications/{applicationId}/transactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_application_ledger_transactions_get_lease_ledger_transaction_by_id(
        self,
        application_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_application_ledger_transactions_get_lease_ledger_transaction_by_id_serialize(
            application_id=application_id,
            transaction_id=transaction_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def external_api_application_ledger_transactions_get_lease_ledger_transaction_by_id_with_http_info(
        self,
        application_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_application_ledger_transactions_get_lease_ledger_transaction_by_id_without_preload_content(
        self,
        application_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_application_ledger_transactions_get_lease_ledger_transaction_by_id_serialize(
        self,
        application_id,
        transaction_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/applications/{applicationId}/transactions/{transactionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_application_outstanding_balances_get_application_outstanding_balances(
        self,
        applicationstatuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results to applications in specific statuses.  If not specified, all application outstanding balances will be returned.")] = None,
        applicationids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to specific applications by their unique identifiers.  If not specified, all application outstanding balances will be returned.")] = None,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[ApplicationOutstandingBalanceMessage]:
        ...
        :param applicationstatuses: Filters results to applications in specific statuses.  If not specified, all application outstanding balances will be returned.
        :type applicationstatuses: List[str]
        :param applicationids: Filters results to specific applications by their unique identifiers.  If not specified, all application outstanding balances will be returned.
        :type applicationids: List[int]
        :param orderby: `orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.
        :type orderby: str
        :param offset: `offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.
        :type offset: int
        ...
        _param = self._external_api_application_outstanding_balances_get_application_outstanding_balances_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ApplicationOutstandingBalanceMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '422': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_application_outstanding_balances_get_application_outstanding_balances_with_http_info(
        self,
        applicationstatuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results to applications in specific statuses.  If not specified, all application outstanding balances will be returned.")] = None,
        applicationids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to specific applications by their unique identifiers.  If not specified, all application outstanding balances will be returned.")] = None,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ApplicationOutstandingBalanceMessage]]:
        """Retrieve all outstanding balances
    ...
    @validate_call
    async def external_api_application_outstanding_balances_get_application_outstanding_balances_without_preload_content(
        self,
        applicationstatuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results to applications in specific statuses.  If not specified, all application outstanding balances will be returned.")] = None,
        applicationids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to specific applications by their unique identifiers.  If not specified, all application outstanding balances will be returned.")] = None,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
    ...
    def _external_api_application_outstanding_balances_get_application_outstanding_balances_serialize(
        self,
        applicationstatuses,
        applicationids,
        orderby,
        ...
        if applicationids is not None:
            
            _query_params.append(('applicationids', applicationids))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/applications/outstandingbalances',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
