...
from mcp_server_buildium.buildium_sdk.models.credit_recurring_transaction_post_message import CreditRecurringTransactionPostMessage
...
from mcp_server_buildium.buildium_sdk.models.ownership_account_deposit_withholding_post_message import OwnershipAccountDepositWithholdingPostMessage
...
from mcp_server_buildium.buildium_sdk.models.ownership_account_ledger_charge_message import OwnershipAccountLedgerChargeMessage
from mcp_server_buildium.buildium_sdk.models.ownership_account_ledger_charge_post_message import OwnershipAccountLedgerChargePostMessage
from mcp_server_buildium.buildium_sdk.models.ownership_account_ledger_charge_put_message import OwnershipAccountLedgerChargePutMessage
...
from mcp_server_buildium.buildium_sdk.models.ownership_account_ledger_payment_put_message import OwnershipAccountLedgerPaymentPutMessage
from mcp_server_buildium.buildium_sdk.models.ownership_account_outstanding_balance_message import OwnershipAccountOutstandingBalanceMessage
from mcp_server_buildium.buildium_sdk.models.ownership_account_recurring_credit_message import OwnershipAccountRecurringCreditMessage
from mcp_server_buildium.buildium_sdk.models.ownership_account_recurring_payment_message import OwnershipAccountRecurringPaymentMessage
from mcp_server_buildium.buildium_sdk.models.ownership_account_refund_message import OwnershipAccountRefundMessage
...
from mcp_server_buildium.buildium_sdk.models.ownership_account_transaction_message import OwnershipAccountTransactionMessage
...
from mcp_server_buildium.buildium_sdk.models.recurring_transaction_message import RecurringTransactionMessage
...
class OwnershipAccountTransactionsApi:
    ...
    @validate_call
    async def external_api_ownership_account_auto_allocated_payment_create_ownership_account_auto_allocated_payment(
        self,
        ownership_account_id: StrictInt,
        ownership_account_auto_allocated_payment_post_message: OwnershipAccountAutoAllocatedPaymentPostMessage,
        ...
        :param ownership_account_auto_allocated_payment_post_message: (required)
        :type ownership_account_auto_allocated_payment_post_message: OwnershipAccountAutoAllocatedPaymentPostMessage
        ...
        _param = self._external_api_ownership_account_auto_allocated_payment_create_ownership_account_auto_allocated_payment_serialize(
            ownership_account_id=ownership_account_id,
            ownership_account_auto_allocated_payment_post_message=ownership_account_auto_allocated_payment_post_message,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "OwnershipAccountTransactionMessage",
    ...
    @validate_call
    async def external_api_ownership_account_auto_allocated_payment_create_ownership_account_auto_allocated_payment_with_http_info(
        self,
        ownership_account_id: StrictInt,
        ownership_account_auto_allocated_payment_post_message: OwnershipAccountAutoAllocatedPaymentPostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OwnershipAccountTransactionMessage]:
        """Create a payment (auto allocated)
    ...
    @validate_call
    async def external_api_ownership_account_auto_allocated_payment_create_ownership_account_auto_allocated_payment_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        ownership_account_auto_allocated_payment_post_message: OwnershipAccountAutoAllocatedPaymentPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_ownership_account_auto_allocated_payment_create_ownership_account_auto_allocated_payment_serialize(
        self,
        ownership_account_id,
        ownership_account_auto_allocated_payment_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if ownership_account_auto_allocated_payment_post_message is not None:
            _body_params = ownership_account_auto_allocated_payment_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/autoallocatedpayments',
    ...
    @validate_call
    async def external_api_ownership_account_charge_recurring_transactions_create_ownership_accounts_charge_recurring_transaction(
        self,
        ownership_account_id: StrictInt,
        ...
        :param ownership_account_id: (required)
        :type ownership_account_id: int
        :param charge_recurring_transaction_post_message: (required)
        :type charge_recurring_transaction_post_message: ChargeRecurringTransactionPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_ownership_account_charge_recurring_transactions_create_ownership_accounts_charge_recurring_transaction_serialize(
            ownership_account_id=ownership_account_id,
            charge_recurring_transaction_post_message=charge_recurring_transaction_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "OwnershipAccountChargeRecurringTransactionMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_ownership_account_charge_recurring_transactions_create_ownership_accounts_charge_recurring_transaction_with_http_info(
        self,
        ownership_account_id: StrictInt,
        charge_recurring_transaction_post_message: ChargeRecurringTransactionPostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OwnershipAccountChargeRecurringTransactionMessage]:
        """Create a recurring charge
    ...
    @validate_call
    async def external_api_ownership_account_charge_recurring_transactions_create_ownership_accounts_charge_recurring_transaction_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        charge_recurring_transaction_post_message: ChargeRecurringTransactionPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_ownership_account_charge_recurring_transactions_create_ownership_accounts_charge_recurring_transaction_serialize(
        self,
        ownership_account_id,
        charge_recurring_transaction_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if charge_recurring_transaction_post_message is not None:
            _body_params = charge_recurring_transaction_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/recurringcharges',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_charge_recurring_transactions_get_ownership_accounts_charge_recurring_transaction_by_id(
        self,
        ownership_account_id: StrictInt,
        ...
        _param = self._external_api_ownership_account_charge_recurring_transactions_get_ownership_accounts_charge_recurring_transaction_by_id_serialize(
            ownership_account_id=ownership_account_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OwnershipAccountChargeRecurringTransactionMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_ownership_account_charge_recurring_transactions_get_ownership_accounts_charge_recurring_transaction_by_id_with_http_info(
        self,
        ownership_account_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_ownership_account_charge_recurring_transactions_get_ownership_accounts_charge_recurring_transaction_by_id_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_ownership_account_charge_recurring_transactions_get_ownership_accounts_charge_recurring_transaction_by_id_serialize(
        self,
        ownership_account_id,
        transaction_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/recurringcharges/{transactionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_deposit_withholding_create_ownership_account_deposit_withholding(
        self,
        ownership_account_id: StrictInt,
        ownership_account_deposit_withholding_post_message: OwnershipAccountDepositWithholdingPostMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ownership_account_id: (required)
        :type ownership_account_id: int
        :param ownership_account_deposit_withholding_post_message: (required)
        :type ownership_account_deposit_withholding_post_message: OwnershipAccountDepositWithholdingPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_ownership_account_deposit_withholding_create_ownership_account_deposit_withholding_serialize(
            ownership_account_id=ownership_account_id,
            ownership_account_deposit_withholding_post_message=ownership_account_deposit_withholding_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_ownership_account_deposit_withholding_create_ownership_account_deposit_withholding_with_http_info(
        self,
        ownership_account_id: StrictInt,
        ownership_account_deposit_withholding_post_message: OwnershipAccountDepositWithholdingPostMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_ownership_account_deposit_withholding_create_ownership_account_deposit_withholding_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        ownership_account_deposit_withholding_post_message: OwnershipAccountDepositWithholdingPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_ownership_account_deposit_withholding_create_ownership_account_deposit_withholding_serialize(
        self,
        ownership_account_id,
        ownership_account_deposit_withholding_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if ownership_account_deposit_withholding_post_message is not None:
            _body_params = ownership_account_deposit_withholding_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/applieddeposits',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_deposit_withholding_update_ownership_account_deposit_withholding(
        self,
        ownership_account_id: StrictInt,
        deposit_id: StrictInt,
        ownership_account_deposit_withholding_put_message: OwnershipAccountDepositWithholdingPutMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type deposit_id: int
        :param ownership_account_deposit_withholding_put_message: (required)
        :type ownership_account_deposit_withholding_put_message: OwnershipAccountDepositWithholdingPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_ownership_account_deposit_withholding_update_ownership_account_deposit_withholding_serialize(
            ownership_account_id=ownership_account_id,
            deposit_id=deposit_id,
            ownership_account_deposit_withholding_put_message=ownership_account_deposit_withholding_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OwnershipAccountTransactionMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_ownership_account_deposit_withholding_update_ownership_account_deposit_withholding_with_http_info(
        self,
        ownership_account_id: StrictInt,
        deposit_id: StrictInt,
        ownership_account_deposit_withholding_put_message: OwnershipAccountDepositWithholdingPutMessage,
    ...
    @validate_call
    async def external_api_ownership_account_deposit_withholding_update_ownership_account_deposit_withholding_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        deposit_id: StrictInt,
        ownership_account_deposit_withholding_put_message: OwnershipAccountDepositWithholdingPutMessage,
    ...
    def _external_api_ownership_account_deposit_withholding_update_ownership_account_deposit_withholding_serialize(
        self,
        ownership_account_id,
        deposit_id,
        ownership_account_deposit_withholding_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if ownership_account_deposit_withholding_put_message is not None:
            _body_params = ownership_account_deposit_withholding_put_message
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/applieddeposits/{depositId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_ledger_charges_create_charge(
        self,
        ...
        :type ownership_account_id: int
        :param ownership_account_ledger_charge_post_message: (required)
        :type ownership_account_ledger_charge_post_message: OwnershipAccountLedgerChargePostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_ownership_account_ledger_charges_create_charge_serialize(
            ownership_account_id=ownership_account_id,
            ownership_account_ledger_charge_post_message=ownership_account_ledger_charge_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_ownership_account_ledger_charges_create_charge_with_http_info(
        self,
        ownership_account_id: Annotated[StrictInt, Field(description="The ownership account identifier.")],
        ownership_account_ledger_charge_post_message: OwnershipAccountLedgerChargePostMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_ownership_account_ledger_charges_create_charge_without_preload_content(
        self,
        ownership_account_id: Annotated[StrictInt, Field(description="The ownership account identifier.")],
        ownership_account_ledger_charge_post_message: OwnershipAccountLedgerChargePostMessage,
        _request_timeout: Union[
    ...
    def _external_api_ownership_account_ledger_charges_create_charge_serialize(
        self,
        ownership_account_id,
        ...
        # process the form parameters
        # process the body parameter
        if ownership_account_ledger_charge_post_message is not None:
            _body_params = ownership_account_ledger_charge_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/charges',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_ledger_charges_get_all_ownership_account_charges(
        self,
        ownership_account_id: StrictInt,
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose start date is greater than or equal to the specified value.")] = None,
        transactiondateto: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose end date is less than or equal to the specified value.")] = None,
        billids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to any charge that has been associated to the indicated bill ids.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[OwnershipAccountLedgerChargeMessage]:
        ...
        :param ownership_account_id: (required)
        :type ownership_account_id: int
        :param transactiondatefrom: Filters results to any lease transaction whose start date is greater than or equal to the specified value.
        :type transactiondatefrom: date
        :param transactiondateto: Filters results to any lease transaction whose end date is less than or equal to the specified value.
        :type transactiondateto: date
        :param billids: Filters results to any charge that has been associated to the indicated bill ids.
        :type billids: List[int]
        ...
        _param = self._external_api_ownership_account_ledger_charges_get_all_ownership_account_charges_serialize(
            ownership_account_id=ownership_account_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[OwnershipAccountLedgerChargeMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_ownership_account_ledger_charges_get_all_ownership_account_charges_with_http_info(
        self,
        ownership_account_id: StrictInt,
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose start date is greater than or equal to the specified value.")] = None,
        transactiondateto: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose end date is less than or equal to the specified value.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[OwnershipAccountLedgerChargeMessage]]:
        """Retrieve all charges
    ...
    @validate_call
    async def external_api_ownership_account_ledger_charges_get_all_ownership_account_charges_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose start date is greater than or equal to the specified value.")] = None,
        transactiondateto: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose end date is less than or equal to the specified value.")] = None,
    ...
    def _external_api_ownership_account_ledger_charges_get_all_ownership_account_charges_serialize(
        self,
        ownership_account_id,
        transactiondatefrom,
        transactiondateto,
        ...
        if billids is not None:
            
            _query_params.append(('billids', billids))
    ...
    @validate_call
    async def external_api_ownership_account_ledger_charges_get_ownership_account_charge_by_id(
        self,
        ownership_account_id: Annotated[StrictInt, Field(description="The ownership account identifier.")],
        charge_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_ownership_account_ledger_charges_get_ownership_account_charge_by_id_serialize(
            ownership_account_id=ownership_account_id,
            charge_id=charge_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OwnershipAccountLedgerChargeMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_ownership_account_ledger_charges_get_ownership_account_charge_by_id_with_http_info(
        self,
        ownership_account_id: Annotated[StrictInt, Field(description="The ownership account identifier.")],
        charge_id: StrictInt,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OwnershipAccountLedgerChargeMessage]:
        """Retrieve a charge
    ...
    @validate_call
    async def external_api_ownership_account_ledger_charges_get_ownership_account_charge_by_id_without_preload_content(
        self,
        ownership_account_id: Annotated[StrictInt, Field(description="The ownership account identifier.")],
        charge_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_ownership_account_ledger_charges_get_ownership_account_charge_by_id_serialize(
        self,
        ownership_account_id,
        charge_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/charges/{chargeId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_ledger_charges_update_ownership_account_charge(
        self,
        ownership_account_id: Annotated[StrictInt, Field(description="The ownership account identifier.")],
        charge_id: Annotated[StrictInt, Field(description="The charge identifier.")],
        ...
        :param ownership_account_id: The ownership account identifier. (required)
        :type ownership_account_id: int
        :param charge_id: The charge identifier. (required)
        :type charge_id: int
        :param ownership_account_ledger_charge_put_message: (required)
        :type ownership_account_ledger_charge_put_message: OwnershipAccountLedgerChargePutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_ownership_account_ledger_charges_update_ownership_account_charge_serialize(
            ownership_account_id=ownership_account_id,
            charge_id=charge_id,
            ownership_account_ledger_charge_put_message=ownership_account_ledger_charge_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_ownership_account_ledger_charges_update_ownership_account_charge_with_http_info(
        self,
        ownership_account_id: Annotated[StrictInt, Field(description="The ownership account identifier.")],
        charge_id: Annotated[StrictInt, Field(description="The charge identifier.")],
        ownership_account_ledger_charge_put_message: OwnershipAccountLedgerChargePutMessage,
    ...
    @validate_call
    async def external_api_ownership_account_ledger_charges_update_ownership_account_charge_without_preload_content(
        self,
        ownership_account_id: Annotated[StrictInt, Field(description="The ownership account identifier.")],
        charge_id: Annotated[StrictInt, Field(description="The charge identifier.")],
        ownership_account_ledger_charge_put_message: OwnershipAccountLedgerChargePutMessage,
    ...
    def _external_api_ownership_account_ledger_charges_update_ownership_account_charge_serialize(
        self,
        ownership_account_id,
        charge_id,
        ...
        # process the form parameters
        # process the body parameter
        if ownership_account_ledger_charge_put_message is not None:
            _body_params = ownership_account_ledger_charge_put_message
    ...
    @validate_call
    async def external_api_ownership_account_ledger_credits_create_ownership_account_credit(
        self,
        ownership_account_id: StrictInt,
        ownership_account_credit_post_message: OwnershipAccountCreditPostMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ownership_account_id: (required)
        :type ownership_account_id: int
        :param ownership_account_credit_post_message: (required)
        :type ownership_account_credit_post_message: OwnershipAccountCreditPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_ownership_account_ledger_credits_create_ownership_account_credit_serialize(
            ownership_account_id=ownership_account_id,
            ownership_account_credit_post_message=ownership_account_credit_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_ownership_account_ledger_credits_create_ownership_account_credit_with_http_info(
        self,
        ownership_account_id: StrictInt,
        ownership_account_credit_post_message: OwnershipAccountCreditPostMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_ownership_account_ledger_credits_create_ownership_account_credit_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        ownership_account_credit_post_message: OwnershipAccountCreditPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_ownership_account_ledger_credits_create_ownership_account_credit_serialize(
        self,
        ownership_account_id,
        ...
        # process the form parameters
        # process the body parameter
        if ownership_account_credit_post_message is not None:
            _body_params = ownership_account_credit_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/credits',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_ledger_payments_create_ownership_account_ledger_payment(
        self,
        ownership_account_id: StrictInt,
        ownership_account_ledger_payment_post_message: OwnershipAccountLedgerPaymentPostMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ownership_account_id: (required)
        :type ownership_account_id: int
        :param ownership_account_ledger_payment_post_message: (required)
        :type ownership_account_ledger_payment_post_message: OwnershipAccountLedgerPaymentPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_ownership_account_ledger_payments_create_ownership_account_ledger_payment_serialize(
            ownership_account_id=ownership_account_id,
            ownership_account_ledger_payment_post_message=ownership_account_ledger_payment_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_ownership_account_ledger_payments_create_ownership_account_ledger_payment_with_http_info(
        self,
        ownership_account_id: StrictInt,
        ownership_account_ledger_payment_post_message: OwnershipAccountLedgerPaymentPostMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_ownership_account_ledger_payments_create_ownership_account_ledger_payment_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        ownership_account_ledger_payment_post_message: OwnershipAccountLedgerPaymentPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_ownership_account_ledger_payments_create_ownership_account_ledger_payment_serialize(
        self,
        ownership_account_id,
        ...
        # process the form parameters
        # process the body parameter
        if ownership_account_ledger_payment_post_message is not None:
            _body_params = ownership_account_ledger_payment_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/payments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_ledger_payments_update_ownership_account_ledger_payment(
        self,
        ownership_account_id: StrictInt,
        ...
        :type payment_id: int
        :param ownership_account_ledger_payment_put_message: (required)
        :type ownership_account_ledger_payment_put_message: OwnershipAccountLedgerPaymentPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_ownership_account_ledger_payments_update_ownership_account_ledger_payment_serialize(
            ownership_account_id=ownership_account_id,
            payment_id=payment_id,
            ownership_account_ledger_payment_put_message=ownership_account_ledger_payment_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_ownership_account_ledger_payments_update_ownership_account_ledger_payment_with_http_info(
        self,
        ownership_account_id: StrictInt,
        payment_id: StrictInt,
        ownership_account_ledger_payment_put_message: OwnershipAccountLedgerPaymentPutMessage,
    ...
    @validate_call
    async def external_api_ownership_account_ledger_payments_update_ownership_account_ledger_payment_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        payment_id: StrictInt,
        ownership_account_ledger_payment_put_message: OwnershipAccountLedgerPaymentPutMessage,
    ...
    def _external_api_ownership_account_ledger_payments_update_ownership_account_ledger_payment_serialize(
        self,
        ownership_account_id,
        payment_id,
        ownership_account_ledger_payment_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if ownership_account_ledger_payment_put_message is not None:
            _body_params = ownership_account_ledger_payment_put_message
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/payments/{paymentId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_outstanding_balances_get_ownership_account_outstanding_balances(
        self,
        associationid: Annotated[Optional[StrictInt], Field(description="Association unique identifier")] = None,
        ownershipaccountstatuses: Annotated[Optional[List[StrictStr]], Field(description="List of ownership account statuses")] = None,
        ownershipaccountids: Annotated[Optional[List[StrictInt]], Field(description="List of ownership account ids")] = None,
        pastdueemail: Annotated[Optional[StrictStr], Field(description="Status of notification of outstanding balances")] = None,
        balanceduration: Annotated[Optional[StrictStr], Field(description="Duration of outstanding balances")] = None,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[OwnershipAccountOutstandingBalanceMessage]:
        ...
        :param associationid: Association unique identifier
        :type associationid: int
        :param ownershipaccountstatuses: List of ownership account statuses
        :type ownershipaccountstatuses: List[str]
        :param ownershipaccountids: List of ownership account ids
        :type ownershipaccountids: List[int]
        :param pastdueemail: Status of notification of outstanding balances
        :type pastdueemail: str
        :param balanceduration: Duration of outstanding balances
        :type balanceduration: str
        :param orderby: `orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.
        :type orderby: str
        :param offset: `offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.
        :type offset: int
        ...
        _param = self._external_api_ownership_account_outstanding_balances_get_ownership_account_outstanding_balances_serialize(
            associationid=associationid,
            ownershipaccountstatuses=ownershipaccountstatuses,
            ownershipaccountids=ownershipaccountids,
            pastdueemail=pastdueemail,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[OwnershipAccountOutstandingBalanceMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '422': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_ownership_account_outstanding_balances_get_ownership_account_outstanding_balances_with_http_info(
        self,
        associationid: Annotated[Optional[StrictInt], Field(description="Association unique identifier")] = None,
        ownershipaccountstatuses: Annotated[Optional[List[StrictStr]], Field(description="List of ownership account statuses")] = None,
        ownershipaccountids: Annotated[Optional[List[StrictInt]], Field(description="List of ownership account ids")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[OwnershipAccountOutstandingBalanceMessage]]:
        """Retrieve all outstanding balances
    ...
    @validate_call
    async def external_api_ownership_account_outstanding_balances_get_ownership_account_outstanding_balances_without_preload_content(
        self,
        associationid: Annotated[Optional[StrictInt], Field(description="Association unique identifier")] = None,
        ownershipaccountstatuses: Annotated[Optional[List[StrictStr]], Field(description="List of ownership account statuses")] = None,
        ownershipaccountids: Annotated[Optional[List[StrictInt]], Field(description="List of ownership account ids")] = None,
    ...
    def _external_api_ownership_account_outstanding_balances_get_ownership_account_outstanding_balances_serialize(
        self,
        associationid,
        ...
        _collection_formats: Dict[str, str] = {
            'ownershipaccountstatuses': 'multi',
        ...
        # process the path parameters
        # process the query parameters
        if associationid is not None:
            
            _query_params.append(('associationid', associationid))
            
        if ownershipaccountstatuses is not None:
            
            _query_params.append(('ownershipaccountstatuses', ownershipaccountstatuses))
            
        if ownershipaccountids is not None:
            
            _query_params.append(('ownershipaccountids', ownershipaccountids))
            
        if pastdueemail is not None:
            
            _query_params.append(('pastdueemail', pastdueemail))
            
        if balanceduration is not None:
            
            _query_params.append(('balanceduration', balanceduration))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/associations/ownershipaccounts/outstandingbalances',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_recurring_credits_create_ownership_account_credit_recurring_transaction(
        self,
        ownership_account_id: StrictInt,
        ...
        :param ownership_account_id: (required)
        :type ownership_account_id: int
        :param credit_recurring_transaction_post_message: (required)
        :type credit_recurring_transaction_post_message: CreditRecurringTransactionPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_ownership_account_recurring_credits_create_ownership_account_credit_recurring_transaction_serialize(
            ownership_account_id=ownership_account_id,
            credit_recurring_transaction_post_message=credit_recurring_transaction_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "OwnershipAccountRecurringCreditMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_ownership_account_recurring_credits_create_ownership_account_credit_recurring_transaction_with_http_info(
        self,
        ownership_account_id: StrictInt,
        credit_recurring_transaction_post_message: CreditRecurringTransactionPostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OwnershipAccountRecurringCreditMessage]:
        """Create a recurring credit
    ...
    @validate_call
    async def external_api_ownership_account_recurring_credits_create_ownership_account_credit_recurring_transaction_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        credit_recurring_transaction_post_message: CreditRecurringTransactionPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_ownership_account_recurring_credits_create_ownership_account_credit_recurring_transaction_serialize(
        self,
        ownership_account_id,
        credit_recurring_transaction_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if credit_recurring_transaction_post_message is not None:
            _body_params = credit_recurring_transaction_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/recurringcredits',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_recurring_credits_get_ownership_account_recurring_credit_by_id(
        self,
        ownership_account_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_ownership_account_recurring_credits_get_ownership_account_recurring_credit_by_id_serialize(
            ownership_account_id=ownership_account_id,
            transaction_id=transaction_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OwnershipAccountRecurringCreditMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_ownership_account_recurring_credits_get_ownership_account_recurring_credit_by_id_with_http_info(
        self,
        ownership_account_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_ownership_account_recurring_credits_get_ownership_account_recurring_credit_by_id_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_ownership_account_recurring_credits_get_ownership_account_recurring_credit_by_id_serialize(
        self,
        ownership_account_id,
        transaction_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/recurringcredits/{transactionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_recurring_payments_create_ownership_account_recurring_payment(
        self,
        ownership_account_id: StrictInt,
        ...
        :param ownership_account_id: (required)
        :type ownership_account_id: int
        :param payment_recurring_transaction_post_message: (required)
        :type payment_recurring_transaction_post_message: PaymentRecurringTransactionPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_ownership_account_recurring_payments_create_ownership_account_recurring_payment_serialize(
            ownership_account_id=ownership_account_id,
            payment_recurring_transaction_post_message=payment_recurring_transaction_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "OwnershipAccountRecurringPaymentMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_ownership_account_recurring_payments_create_ownership_account_recurring_payment_with_http_info(
        self,
        ownership_account_id: StrictInt,
        payment_recurring_transaction_post_message: PaymentRecurringTransactionPostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OwnershipAccountRecurringPaymentMessage]:
        """Create a recurring payment
    ...
    @validate_call
    async def external_api_ownership_account_recurring_payments_create_ownership_account_recurring_payment_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        payment_recurring_transaction_post_message: PaymentRecurringTransactionPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_ownership_account_recurring_payments_create_ownership_account_recurring_payment_serialize(
        self,
        ownership_account_id,
        ...
        # process the form parameters
        # process the body parameter
        if payment_recurring_transaction_post_message is not None:
            _body_params = payment_recurring_transaction_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/recurringpayments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_recurring_payments_get_recurring_ownership_account_payments_by_id(
        self,
        ownership_account_id: StrictInt,
        payment_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_ownership_account_recurring_payments_get_recurring_ownership_account_payments_by_id_serialize(
            ownership_account_id=ownership_account_id,
            payment_id=payment_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OwnershipAccountRecurringPaymentMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_ownership_account_recurring_payments_get_recurring_ownership_account_payments_by_id_with_http_info(
        self,
        ownership_account_id: StrictInt,
        payment_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_ownership_account_recurring_payments_get_recurring_ownership_account_payments_by_id_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        payment_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_ownership_account_recurring_payments_get_recurring_ownership_account_payments_by_id_serialize(
        self,
        ownership_account_id,
        payment_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/recurringpayments/{paymentId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_recurring_transactions_get_association_recurring_transaction(
        self,
        ownership_account_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[RecurringTransactionMessage]:
        ...
        _param = self._external_api_ownership_account_recurring_transactions_get_association_recurring_transaction_serialize(
            ownership_account_id=ownership_account_id,
            orderby=orderby,
            offset=offset,
            limit=limit,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RecurringTransactionMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_ownership_account_recurring_transactions_get_association_recurring_transaction_with_http_info(
        self,
        ownership_account_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RecurringTransactionMessage]]:
        """Retrieve all recurring transactions
    ...
    @validate_call
    async def external_api_ownership_account_recurring_transactions_get_association_recurring_transaction_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
    ...
    def _external_api_ownership_account_recurring_transactions_get_association_recurring_transaction_serialize(
        self,
        ownership_account_id,
        orderby,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/recurringtransactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_recurring_transactions_get_recurring_transactions_for_all_ownership_accounts(
        self,
        ownershipaccountids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to only include records associated with the provided ownership account Ids.")] = None,
        createddatetimefrom: Annotated[Optional[datetime], Field(description="Filters results to recurring transactions created after the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.")] = None,
        createddatetimeto: Annotated[Optional[datetime], Field(description="Filters results to recurring transactions created before the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.")] = None,
        lastupdatedfrom: Annotated[Optional[datetime], Field(description="Filters results to recurring transactions last updated after the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.")] = None,
        lastupdatedto: Annotated[Optional[datetime], Field(description="Filters results to recurring transactions last updated before the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.")] = None,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[BulkOwnershipAccountRecurringTransactionMessage]:
        ...
        :param ownershipaccountids: Filters results to only include records associated with the provided ownership account Ids.
        :type ownershipaccountids: List[int]
        :param createddatetimefrom: Filters results to recurring transactions created after the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.
        :type createddatetimefrom: datetime
        :param createddatetimeto: Filters results to recurring transactions created before the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.
        :type createddatetimeto: datetime
        :param lastupdatedfrom: Filters results to recurring transactions last updated after the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.
        :type lastupdatedfrom: datetime
        :param lastupdatedto: Filters results to recurring transactions last updated before the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.
        ...
        _param = self._external_api_ownership_account_recurring_transactions_get_recurring_transactions_for_all_ownership_accounts_serialize(
            ownershipaccountids=ownershipaccountids,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[BulkOwnershipAccountRecurringTransactionMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '422': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_ownership_account_recurring_transactions_get_recurring_transactions_for_all_ownership_accounts_with_http_info(
        self,
        ownershipaccountids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to only include records associated with the provided ownership account Ids.")] = None,
        createddatetimefrom: Annotated[Optional[datetime], Field(description="Filters results to recurring transactions created after the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.")] = None,
        createddatetimeto: Annotated[Optional[datetime], Field(description="Filters results to recurring transactions created before the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[BulkOwnershipAccountRecurringTransactionMessage]]:
        """Retrieve all recurring transactions for all ownership accounts
    ...
    @validate_call
    async def external_api_ownership_account_recurring_transactions_get_recurring_transactions_for_all_ownership_accounts_without_preload_content(
        self,
        ownershipaccountids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to only include records associated with the provided ownership account Ids.")] = None,
        createddatetimefrom: Annotated[Optional[datetime], Field(description="Filters results to recurring transactions created after the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.")] = None,
        createddatetimeto: Annotated[Optional[datetime], Field(description="Filters results to recurring transactions created before the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.")] = None,
    ...
    def _external_api_ownership_account_recurring_transactions_get_recurring_transactions_for_all_ownership_accounts_serialize(
        self,
        ownershipaccountids,
        createddatetimefrom,
        createddatetimeto,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/associations/ownershipaccounts/recurringtransactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_refund_create_ownership_account_refund(
        self,
        ownership_account_id: StrictInt,
        ownership_account_refund_post_message: OwnershipAccountRefundPostMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param ownership_account_id: (required)
        :type ownership_account_id: int
        :param ownership_account_refund_post_message: (required)
        :type ownership_account_refund_post_message: OwnershipAccountRefundPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_ownership_account_refund_create_ownership_account_refund_serialize(
            ownership_account_id=ownership_account_id,
            ownership_account_refund_post_message=ownership_account_refund_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "OwnershipAccountRefundMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_ownership_account_refund_create_ownership_account_refund_with_http_info(
        self,
        ownership_account_id: StrictInt,
        ownership_account_refund_post_message: OwnershipAccountRefundPostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OwnershipAccountRefundMessage]:
        """Create a refund
    ...
    @validate_call
    async def external_api_ownership_account_refund_create_ownership_account_refund_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        ownership_account_refund_post_message: OwnershipAccountRefundPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_ownership_account_refund_create_ownership_account_refund_serialize(
        self,
        ownership_account_id,
        ...
        # process the form parameters
        # process the body parameter
        if ownership_account_refund_post_message is not None:
            _body_params = ownership_account_refund_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/refunds',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_account_refund_get_ownership_account_refund_by_id(
        self,
        ownership_account_id: StrictInt,
        refund_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_ownership_account_refund_get_ownership_account_refund_by_id_serialize(
            ownership_account_id=ownership_account_id,
            refund_id=refund_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OwnershipAccountRefundMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_ownership_account_refund_get_ownership_account_refund_by_id_with_http_info(
        self,
        ownership_account_id: StrictInt,
        refund_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_ownership_account_refund_get_ownership_account_refund_by_id_without_preload_content(
        self,
        ownership_account_id: StrictInt,
        refund_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_ownership_account_refund_get_ownership_account_refund_by_id_serialize(
        self,
        ownership_account_id,
        refund_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/refunds/{refundId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_accounts_ledger_get_ownership_account_ledger(
        self,
        ownership_account_id: Annotated[StrictInt, Field(description="The ownership account identifier.")],
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose start date is greater than or equal to the specified value.")] = None,
        transactiondateto: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose end date is less than or equal to the specified value.")] = None,
        transactiontypes: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any lease transaction whose lease transaction type matches the specified status. If no type is specified, lease transactions with any type will be returned.")] = None,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[OwnershipAccountTransactionMessage]:
        ...
        :param transactiondateto: Filters results to any lease transaction whose end date is less than or equal to the specified value.
        :type transactiondateto: date
        :param transactiontypes: Filters results to any lease transaction whose lease transaction type matches the specified status. If no type is specified, lease transactions with any type will be returned.
        ...
        _param = self._external_api_ownership_accounts_ledger_get_ownership_account_ledger_serialize(
            ownership_account_id=ownership_account_id,
            transactiondatefrom=transactiondatefrom,
            transactiondateto=transactiondateto,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[OwnershipAccountTransactionMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_ownership_accounts_ledger_get_ownership_account_ledger_with_http_info(
        self,
        ownership_account_id: Annotated[StrictInt, Field(description="The ownership account identifier.")],
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose start date is greater than or equal to the specified value.")] = None,
        transactiondateto: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose end date is less than or equal to the specified value.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[OwnershipAccountTransactionMessage]]:
        """Retrieve all transactions
    ...
    @validate_call
    async def external_api_ownership_accounts_ledger_get_ownership_account_ledger_without_preload_content(
        self,
        ownership_account_id: Annotated[StrictInt, Field(description="The ownership account identifier.")],
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose start date is greater than or equal to the specified value.")] = None,
        transactiondateto: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose end date is less than or equal to the specified value.")] = None,
    ...
    def _external_api_ownership_accounts_ledger_get_ownership_account_ledger_serialize(
        self,
        ownership_account_id,
        transactiondatefrom,
        transactiondateto,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/transactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_ownership_accounts_ledger_get_ownership_account_transaction_by_id(
        self,
        ownership_account_id: Annotated[StrictInt, Field(description="The ownership account identifier.")],
        transaction_id: Annotated[StrictInt, Field(description="The transaction identifier.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._external_api_ownership_accounts_ledger_get_ownership_account_transaction_by_id_serialize(
            ownership_account_id=ownership_account_id,
            transaction_id=transaction_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def external_api_ownership_accounts_ledger_get_ownership_account_transaction_by_id_with_http_info(
        self,
        ownership_account_id: Annotated[StrictInt, Field(description="The ownership account identifier.")],
        transaction_id: Annotated[StrictInt, Field(description="The transaction identifier.")],
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_ownership_accounts_ledger_get_ownership_account_transaction_by_id_without_preload_content(
        self,
        ownership_account_id: Annotated[StrictInt, Field(description="The ownership account identifier.")],
        transaction_id: Annotated[StrictInt, Field(description="The transaction identifier.")],
        _request_timeout: Union[
    ...
    def _external_api_ownership_accounts_ledger_get_ownership_account_transaction_by_id_serialize(
        self,
        ownership_account_id,
        transaction_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/associations/ownershipaccounts/{ownershipAccountId}/transactions/{transactionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
