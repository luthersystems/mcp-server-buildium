...
from mcp_server_buildium.buildium_sdk.models.bank_account_check_message import BankAccountCheckMessage
from mcp_server_buildium.buildium_sdk.models.bank_account_check_post_message import BankAccountCheckPostMessage
from mcp_server_buildium.buildium_sdk.models.bank_account_check_put_message import BankAccountCheckPutMessage
from mcp_server_buildium.buildium_sdk.models.bank_account_deposit_message import BankAccountDepositMessage
from mcp_server_buildium.buildium_sdk.models.bank_account_deposit_post_message import BankAccountDepositPostMessage
from mcp_server_buildium.buildium_sdk.models.bank_account_deposit_put_message import BankAccountDepositPutMessage
from mcp_server_buildium.buildium_sdk.models.bank_account_message import BankAccountMessage
...
from mcp_server_buildium.buildium_sdk.models.bank_account_quick_deposit_save_message import BankAccountQuickDepositSaveMessage
from mcp_server_buildium.buildium_sdk.models.bank_account_reconciliation_balance_message import BankAccountReconciliationBalanceMessage
from mcp_server_buildium.buildium_sdk.models.bank_account_reconciliation_balance_put_message import BankAccountReconciliationBalancePutMessage
from mcp_server_buildium.buildium_sdk.models.bank_account_reconciliation_message import BankAccountReconciliationMessage
from mcp_server_buildium.buildium_sdk.models.bank_account_reconciliation_transaction_message import BankAccountReconciliationTransactionMessage
from mcp_server_buildium.buildium_sdk.models.bank_account_transaction_message import BankAccountTransactionMessage
from mcp_server_buildium.buildium_sdk.models.bank_account_transfer_message import BankAccountTransferMessage
from mcp_server_buildium.buildium_sdk.models.bank_account_transfer_save_message import BankAccountTransferSaveMessage
from mcp_server_buildium.buildium_sdk.models.bank_account_withdrawal_message import BankAccountWithdrawalMessage
from mcp_server_buildium.buildium_sdk.models.bank_account_withdrawal_save_message import BankAccountWithdrawalSaveMessage
...
from mcp_server_buildium.buildium_sdk.models.bank_reconciliation_put_message import BankReconciliationPutMessage
from mcp_server_buildium.buildium_sdk.models.bank_reconciliation_unclear_transactions_post_message import BankReconciliationUnclearTransactionsPostMessage
...
class BankAccountsApi:
    ...
    @validate_call
    async def external_api_bank_account_check_file_download_requests_download_check_file(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        file_id: StrictInt,
        ...
        _param = self._external_api_bank_account_check_file_download_requests_download_check_file_serialize(
    ...
    @validate_call
    async def external_api_bank_account_check_file_download_requests_download_check_file_with_http_info(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        file_id: StrictInt,
    ...
    @validate_call
    async def external_api_bank_account_check_file_download_requests_download_check_file_without_preload_content(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        file_id: StrictInt,
    ...
    def _external_api_bank_account_check_file_download_requests_download_check_file_serialize(
        self,
        bank_account_id,
        check_id,
        file_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/bankaccounts/{bankAccountId}/checks/{checkId}/files/{fileId}/downloadrequests',
    ...
    @validate_call
    async def external_api_bank_account_check_file_uploads_create_check_upload_file_request(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        ...
        Uploads a file and associates it to the specified check record.      Uploading a file requires making two API requests. Each step is outlined below.      <strong>Step 1 - Save file metadata</strong>    The first step in the file upload process is to submit the file metadata to `/v1/bankaccounts/{bankAccountId:int}/checks/{checkId:int}/files/uploadrequests`. The response of this call will contain a URL and a collection of form data that will be used in step 2 to generate the request for the file binary upload.      <strong>NOTE:</strong> The response data will expire after 5 minutes. The file metadata will not be saved in the Buildium system if step 2 of this process is not completed successfully.      <strong>Step 2 - Upload the file binary</strong>    Uploading the file binary will require using the response from step 1 to form a POST request to the Buildium file provider. Follow these steps to create the request:      1. Form a POST request using the value of the `BucketUrl` property as the URL.         2. Set the `Content-Type` header to `multipart/form-data`.        3. Copy the fields from the `FormData`  property to this request as form-data key/value pairs.    <strong>NOTE:</strong> These values must added to the request form-data in the order they were received in the response.        4. Lastly create a form-data key named `file` and set the value to the file binary.    <strong>NOTE:</strong> This must be the last field in the form-data list.      This image shows what the POST request should look like if you're using Postman:  <img src=\"file-upload-example.png\" />      5. Send the POST request! A successful request will return with a `204 - NO CONTENT` HTTP response code. For any failure responses, please refer to <a target=\"_blank\" href=\"https://docs.aws.amazon.com/AmazonS3/latest/API/ErrorResponses.html#RESTErrorResponses\">AWS documentation</a> on REST error responses.      <strong>NOTE:</strong> The file identifier is not generated in this response. To retrieve the file identifier, call `/v1/files` and pass the `PhysicalFileName` value received from the response of this endpoint into the `physicalfilenames` query parameter.      <h4>Required permission(s):</h4><span class=\"permissionBlock\">Accounting > Checks</span> - `View` `Edit`  <span class=\"permissionBlock\">Accounting > General Ledger Transactions</span> - `View` <span class=\"permissionBlock\">(Required for checks associated with a Company) </span>
        ...
        _param = self._external_api_bank_account_check_file_uploads_create_check_upload_file_request_serialize(
            bank_account_id=bank_account_id,
            check_id=check_id,
    ...
    @validate_call
    async def external_api_bank_account_check_file_uploads_create_check_upload_file_request_with_http_info(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        file_name_post_message: FileNamePostMessage,
    ...
    @validate_call
    async def external_api_bank_account_check_file_uploads_create_check_upload_file_request_without_preload_content(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        file_name_post_message: FileNamePostMessage,
    ...
    def _external_api_bank_account_check_file_uploads_create_check_upload_file_request_serialize(
        self,
        bank_account_id,
        check_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/bankaccounts/{bankAccountId}/checks/{checkId}/files/uploadrequests',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_check_files_delete_bank_account_check_file(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        file_id: StrictInt,
        ...
        _param = self._external_api_bank_account_check_files_delete_bank_account_check_file_serialize(
            bank_account_id=bank_account_id,
            check_id=check_id,
            file_id=file_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def external_api_bank_account_check_files_delete_bank_account_check_file_with_http_info(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        file_id: StrictInt,
    ...
    @validate_call
    async def external_api_bank_account_check_files_delete_bank_account_check_file_without_preload_content(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        file_id: StrictInt,
    ...
    def _external_api_bank_account_check_files_delete_bank_account_check_file_serialize(
        self,
        bank_account_id,
        check_id,
        file_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/bankaccounts/{bankAccountId}/checks/{checkId}/files/{fileId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_check_files_get_bank_account_check_file_by_id(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        file_id: StrictInt,
        ...
        _param = self._external_api_bank_account_check_files_get_bank_account_check_file_by_id_serialize(
            bank_account_id=bank_account_id,
            check_id=check_id,
            file_id=file_id,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BankAccountCheckFileMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_check_files_get_bank_account_check_file_by_id_with_http_info(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        file_id: StrictInt,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BankAccountCheckFileMessage]:
        """Retrieve a file for a check
    ...
    @validate_call
    async def external_api_bank_account_check_files_get_bank_account_check_file_by_id_without_preload_content(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        file_id: StrictInt,
    ...
    def _external_api_bank_account_check_files_get_bank_account_check_file_by_id_serialize(
        self,
        bank_account_id,
        check_id,
        file_id,
    ...
    @validate_call
    async def external_api_bank_account_check_files_get_files_for_bank_account_check(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[BankAccountCheckFileMessage]:
        ...
        _param = self._external_api_bank_account_check_files_get_files_for_bank_account_check_serialize(
            bank_account_id=bank_account_id,
            check_id=check_id,
            orderby=orderby,
            offset=offset,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[BankAccountCheckFileMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_check_files_get_files_for_bank_account_check_with_http_info(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[BankAccountCheckFileMessage]]:
        """Retrieve all files for a check
    ...
    @validate_call
    async def external_api_bank_account_check_files_get_files_for_bank_account_check_without_preload_content(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
    ...
    def _external_api_bank_account_check_files_get_files_for_bank_account_check_serialize(
        self,
        bank_account_id,
        check_id,
        orderby,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/bankaccounts/{bankAccountId}/checks/{checkId}/files',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_checks_create_bank_account_check(
        self,
        bank_account_id: StrictInt,
        ...
        :param bank_account_id: (required)
        :type bank_account_id: int
        :param bank_account_check_post_message: (required)
        :type bank_account_check_post_message: BankAccountCheckPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_bank_account_checks_create_bank_account_check_serialize(
            bank_account_id=bank_account_id,
            bank_account_check_post_message=bank_account_check_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_bank_account_checks_create_bank_account_check_with_http_info(
        self,
        bank_account_id: StrictInt,
        bank_account_check_post_message: BankAccountCheckPostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BankAccountCheckMessage]:
        """Create a check
    ...
    @validate_call
    async def external_api_bank_account_checks_create_bank_account_check_without_preload_content(
        self,
        bank_account_id: StrictInt,
        bank_account_check_post_message: BankAccountCheckPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_bank_account_checks_create_bank_account_check_serialize(
        self,
        bank_account_id,
        ...
        # process the form parameters
        # process the body parameter
        if bank_account_check_post_message is not None:
            _body_params = bank_account_check_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/bankaccounts/{bankAccountId}/checks',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_checks_get_bank_account_checks(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
        _request_timeout: Union[
        ...
        :param bank_account_id: (required)
        :type bank_account_id: int
        :param startdate: Filters results to any transactions that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD. (required)
        :type startdate: date
        :param enddate: Filters results to any transactions that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD. (required)
        :type enddate: date
        :param orderby: `orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.
        :type orderby: str
        :param offset: `offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.
        ...
        _param = self._external_api_bank_account_checks_get_bank_account_checks_serialize(
            bank_account_id=bank_account_id,
            startdate=startdate,
            enddate=enddate,
            orderby=orderby,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[BankAccountCheckMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_checks_get_bank_account_checks_with_http_info(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[BankAccountCheckMessage]]:
        """Retrieve all checks
    ...
    @validate_call
    async def external_api_bank_account_checks_get_bank_account_checks_without_preload_content(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
    ...
    def _external_api_bank_account_checks_get_bank_account_checks_serialize(
        self,
        bank_account_id,
        startdate,
        enddate,
    ...
    @validate_call
    async def external_api_bank_account_checks_get_check_for_bank_account(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_bank_account_checks_get_check_for_bank_account_serialize(
            bank_account_id=bank_account_id,
            check_id=check_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def external_api_bank_account_checks_get_check_for_bank_account_with_http_info(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_bank_account_checks_get_check_for_bank_account_without_preload_content(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_bank_account_checks_get_check_for_bank_account_serialize(
        self,
        bank_account_id,
        check_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/bankaccounts/{bankAccountId}/checks/{checkId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_checks_update_check_for_bank_account(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        ...
        :param check_id: (required)
        :type check_id: int
        :param bank_account_check_put_message: (required)
        :type bank_account_check_put_message: BankAccountCheckPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_bank_account_checks_update_check_for_bank_account_serialize(
            bank_account_id=bank_account_id,
            check_id=check_id,
            bank_account_check_put_message=bank_account_check_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_bank_account_checks_update_check_for_bank_account_with_http_info(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        bank_account_check_put_message: BankAccountCheckPutMessage,
    ...
    @validate_call
    async def external_api_bank_account_checks_update_check_for_bank_account_without_preload_content(
        self,
        bank_account_id: StrictInt,
        check_id: StrictInt,
        bank_account_check_put_message: BankAccountCheckPutMessage,
    ...
    def _external_api_bank_account_checks_update_check_for_bank_account_serialize(
        self,
        bank_account_id,
        check_id,
        bank_account_check_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if bank_account_check_put_message is not None:
            _body_params = bank_account_check_put_message
    ...
    @validate_call
    async def external_api_bank_account_deposits_create_bank_account_deposit(
        self,
        bank_account_id: StrictInt,
        ...
        :param bank_account_id: (required)
        :type bank_account_id: int
        :param bank_account_deposit_post_message: (required)
        :type bank_account_deposit_post_message: BankAccountDepositPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_bank_account_deposits_create_bank_account_deposit_serialize(
            bank_account_id=bank_account_id,
            bank_account_deposit_post_message=bank_account_deposit_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_bank_account_deposits_create_bank_account_deposit_with_http_info(
        self,
        bank_account_id: StrictInt,
        bank_account_deposit_post_message: BankAccountDepositPostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BankAccountDepositMessage]:
        """Create a deposit
    ...
    @validate_call
    async def external_api_bank_account_deposits_create_bank_account_deposit_without_preload_content(
        self,
        bank_account_id: StrictInt,
        bank_account_deposit_post_message: BankAccountDepositPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_bank_account_deposits_create_bank_account_deposit_serialize(
        self,
        bank_account_id,
        bank_account_deposit_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if bank_account_deposit_post_message is not None:
            _body_params = bank_account_deposit_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/bankaccounts/{bankAccountId}/deposits',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_deposits_get_bank_account_deposit_by_id(
        self,
        bank_account_id: StrictInt,
        deposit_id: StrictInt,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._external_api_bank_account_deposits_get_bank_account_deposit_by_id_serialize(
            bank_account_id=bank_account_id,
    ...
    @validate_call
    async def external_api_bank_account_deposits_get_bank_account_deposit_by_id_with_http_info(
        self,
        bank_account_id: StrictInt,
        deposit_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_bank_account_deposits_get_bank_account_deposit_by_id_without_preload_content(
        self,
        bank_account_id: StrictInt,
        deposit_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_bank_account_deposits_get_bank_account_deposit_by_id_serialize(
        self,
        bank_account_id,
        deposit_id,
        _request_auth,
        ...
        if deposit_id is not None:
            _path_params['depositId'] = deposit_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/bankaccounts/{bankAccountId}/deposits/{depositId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_deposits_get_bank_account_deposits(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any deposits that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any deposits that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[BankAccountDepositMessage]:
        ...
        :param bank_account_id: (required)
        :type bank_account_id: int
        :param startdate: Filters results to any deposits that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD. (required)
        :type startdate: date
        :param enddate: Filters results to any deposits that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD. (required)
        :type enddate: date
        :param orderby: `orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.
        :type orderby: str
        :param offset: `offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.
        ...
        _param = self._external_api_bank_account_deposits_get_bank_account_deposits_serialize(
            bank_account_id=bank_account_id,
            startdate=startdate,
            enddate=enddate,
            orderby=orderby,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[BankAccountDepositMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_deposits_get_bank_account_deposits_with_http_info(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any deposits that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any deposits that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[BankAccountDepositMessage]]:
        """Retrieve all deposits
    ...
    @validate_call
    async def external_api_bank_account_deposits_get_bank_account_deposits_without_preload_content(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any deposits that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any deposits that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
    ...
    def _external_api_bank_account_deposits_get_bank_account_deposits_serialize(
        self,
        bank_account_id,
        startdate,
        enddate,
    ...
    @validate_call
    async def external_api_bank_account_deposits_update_bank_account_deposit(
        self,
        bank_account_id: StrictInt,
        deposit_id: StrictInt,
        ...
        :param deposit_id: (required)
        :type deposit_id: int
        :param bank_account_deposit_put_message: (required)
        :type bank_account_deposit_put_message: BankAccountDepositPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_bank_account_deposits_update_bank_account_deposit_serialize(
            bank_account_id=bank_account_id,
            deposit_id=deposit_id,
            bank_account_deposit_put_message=bank_account_deposit_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_bank_account_deposits_update_bank_account_deposit_with_http_info(
        self,
        bank_account_id: StrictInt,
        deposit_id: StrictInt,
        bank_account_deposit_put_message: BankAccountDepositPutMessage,
    ...
    @validate_call
    async def external_api_bank_account_deposits_update_bank_account_deposit_without_preload_content(
        self,
        bank_account_id: StrictInt,
        deposit_id: StrictInt,
        bank_account_deposit_put_message: BankAccountDepositPutMessage,
    ...
    def _external_api_bank_account_deposits_update_bank_account_deposit_serialize(
        self,
        bank_account_id,
        deposit_id,
        bank_account_deposit_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if bank_account_deposit_put_message is not None:
            _body_params = bank_account_deposit_put_message
    ...
    @validate_call
    async def external_api_bank_account_pending_reconciliations_create_pending_reconciliations(
        self,
        bank_account_id: StrictInt,
        bank_pending_reconciliation_post_message: BankPendingReconciliationPostMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param bank_account_id: (required)
        :type bank_account_id: int
        :param bank_pending_reconciliation_post_message: (required)
        :type bank_pending_reconciliation_post_message: BankPendingReconciliationPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_bank_account_pending_reconciliations_create_pending_reconciliations_serialize(
            bank_account_id=bank_account_id,
            bank_pending_reconciliation_post_message=bank_pending_reconciliation_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "BankAccountReconciliationMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_pending_reconciliations_create_pending_reconciliations_with_http_info(
        self,
        bank_account_id: StrictInt,
        bank_pending_reconciliation_post_message: BankPendingReconciliationPostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BankAccountReconciliationMessage]:
        """Create a reconciliation
    ...
    @validate_call
    async def external_api_bank_account_pending_reconciliations_create_pending_reconciliations_without_preload_content(
        self,
        bank_account_id: StrictInt,
        bank_pending_reconciliation_post_message: BankPendingReconciliationPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_bank_account_pending_reconciliations_create_pending_reconciliations_serialize(
        self,
        bank_account_id,
        bank_pending_reconciliation_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if bank_pending_reconciliation_post_message is not None:
            _body_params = bank_pending_reconciliation_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/bankaccounts/{bankAccountId}/reconciliations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_quick_deposits_create_quick_deposit(
        self,
        bank_account_id: StrictInt,
        ...
        :param bank_account_id: (required)
        :type bank_account_id: int
        :param bank_account_quick_deposit_save_message: (required)
        :type bank_account_quick_deposit_save_message: BankAccountQuickDepositSaveMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_bank_account_quick_deposits_create_quick_deposit_serialize(
            bank_account_id=bank_account_id,
            bank_account_quick_deposit_save_message=bank_account_quick_deposit_save_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "BankAccountQuickDepositMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_quick_deposits_create_quick_deposit_with_http_info(
        self,
        bank_account_id: StrictInt,
        bank_account_quick_deposit_save_message: BankAccountQuickDepositSaveMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BankAccountQuickDepositMessage]:
        """Create a quick deposit
    ...
    @validate_call
    async def external_api_bank_account_quick_deposits_create_quick_deposit_without_preload_content(
        self,
        bank_account_id: StrictInt,
        bank_account_quick_deposit_save_message: BankAccountQuickDepositSaveMessage,
        _request_timeout: Union[
    ...
    def _external_api_bank_account_quick_deposits_create_quick_deposit_serialize(
        self,
        bank_account_id,
        bank_account_quick_deposit_save_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if bank_account_quick_deposit_save_message is not None:
            _body_params = bank_account_quick_deposit_save_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/bankaccounts/{bankAccountId}/quickdeposits',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_quick_deposits_get_all_quick_deposits(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[BankAccountQuickDepositMessage]:
        ...
        _param = self._external_api_bank_account_quick_deposits_get_all_quick_deposits_serialize(
            bank_account_id=bank_account_id,
            startdate=startdate,
            enddate=enddate,
            orderby=orderby,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[BankAccountQuickDepositMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_quick_deposits_get_all_quick_deposits_with_http_info(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[BankAccountQuickDepositMessage]]:
        """Retrieve all quick deposits
    ...
    @validate_call
    async def external_api_bank_account_quick_deposits_get_all_quick_deposits_without_preload_content(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
    ...
    def _external_api_bank_account_quick_deposits_get_all_quick_deposits_serialize(
        self,
        bank_account_id,
        startdate,
        enddate,
    ...
    @validate_call
    async def external_api_bank_account_quick_deposits_get_quick_deposit_by_id(
        self,
        bank_account_id: StrictInt,
        quick_deposit_id: StrictInt,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param bank_account_id: (required)
        :type bank_account_id: int
        :param quick_deposit_id: (required)
        :type quick_deposit_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_bank_account_quick_deposits_get_quick_deposit_by_id_serialize(
            bank_account_id=bank_account_id,
            quick_deposit_id=quick_deposit_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BankAccountQuickDepositMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_quick_deposits_get_quick_deposit_by_id_with_http_info(
        self,
        bank_account_id: StrictInt,
        quick_deposit_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_bank_account_quick_deposits_get_quick_deposit_by_id_without_preload_content(
        self,
        bank_account_id: StrictInt,
        quick_deposit_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_bank_account_quick_deposits_get_quick_deposit_by_id_serialize(
        self,
        bank_account_id,
        quick_deposit_id,
        _request_auth,
        ...
        if bank_account_id is not None:
            _path_params['bankAccountId'] = bank_account_id
        if quick_deposit_id is not None:
            _path_params['quickDepositId'] = quick_deposit_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/bankaccounts/{bankAccountId}/quickdeposits/{quickDepositId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_quick_deposits_update_quick_deposit(
        self,
        bank_account_id: StrictInt,
        quick_deposit_id: StrictInt,
        bank_account_quick_deposit_save_message: BankAccountQuickDepositSaveMessage,
        ...
        _param = self._external_api_bank_account_quick_deposits_update_quick_deposit_serialize(
            bank_account_id=bank_account_id,
            quick_deposit_id=quick_deposit_id,
            bank_account_quick_deposit_save_message=bank_account_quick_deposit_save_message,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def external_api_bank_account_quick_deposits_update_quick_deposit_with_http_info(
        self,
        bank_account_id: StrictInt,
        quick_deposit_id: StrictInt,
        bank_account_quick_deposit_save_message: BankAccountQuickDepositSaveMessage,
    ...
    @validate_call
    async def external_api_bank_account_quick_deposits_update_quick_deposit_without_preload_content(
        self,
        bank_account_id: StrictInt,
        quick_deposit_id: StrictInt,
        bank_account_quick_deposit_save_message: BankAccountQuickDepositSaveMessage,
    ...
    def _external_api_bank_account_quick_deposits_update_quick_deposit_serialize(
        self,
        bank_account_id,
        quick_deposit_id,
        bank_account_quick_deposit_save_message,
    ...
    @validate_call
    async def external_api_bank_account_reconciliation_finalize_finalize_reconciliation(
        self,
        bank_account_id: StrictInt,
        ...
        :param bank_account_id: (required)
        :type bank_account_id: int
        :param reconciliation_id: (required)
        ...
        _param = self._external_api_bank_account_reconciliation_finalize_finalize_reconciliation_serialize(
            bank_account_id=bank_account_id,
    ...
    @validate_call
    async def external_api_bank_account_reconciliation_finalize_finalize_reconciliation_with_http_info(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_bank_account_reconciliation_finalize_finalize_reconciliation_without_preload_content(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_bank_account_reconciliation_finalize_finalize_reconciliation_serialize(
        self,
        bank_account_id,
        reconciliation_id,
        _request_auth,
        ...
        if reconciliation_id is not None:
            _path_params['reconciliationId'] = reconciliation_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/bankaccounts/{bankAccountId}/reconciliations/{reconciliationId}/finalizerequest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_read_get_bank_account_reconciliation_transactions(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[BankAccountReconciliationTransactionMessage]:
        """Retrieve all transactions for a reconciliation
        ...
        _param = self._external_api_bank_account_reconciliations_read_get_bank_account_reconciliation_transactions_serialize(
            bank_account_id=bank_account_id,
            reconciliation_id=reconciliation_id,
            orderby=orderby,
            offset=offset,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[BankAccountReconciliationTransactionMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_read_get_bank_account_reconciliation_transactions_with_http_info(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[BankAccountReconciliationTransactionMessage]]:
        """Retrieve all transactions for a reconciliation
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_read_get_bank_account_reconciliation_transactions_without_preload_content(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
    ...
    def _external_api_bank_account_reconciliations_read_get_bank_account_reconciliation_transactions_serialize(
        self,
        bank_account_id,
        reconciliation_id,
        orderby,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/bankaccounts/{bankAccountId}/reconciliations/{reconciliationId}/transactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_read_get_reconciliation_balance_by_id(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_bank_account_reconciliations_read_get_reconciliation_balance_by_id_serialize(
            bank_account_id=bank_account_id,
            reconciliation_id=reconciliation_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BankAccountReconciliationBalanceMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_read_get_reconciliation_balance_by_id_with_http_info(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BankAccountReconciliationBalanceMessage]:
        """Retrieve a reconciliation's balance
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_read_get_reconciliation_balance_by_id_without_preload_content(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_bank_account_reconciliations_read_get_reconciliation_balance_by_id_serialize(
        self,
        bank_account_id,
        reconciliation_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/bankaccounts/{bankAccountId}/reconciliations/{reconciliationId}/balances',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_read_get_reconciliation_by_id(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_bank_account_reconciliations_read_get_reconciliation_by_id_serialize(
            bank_account_id=bank_account_id,
            reconciliation_id=reconciliation_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BankAccountReconciliationMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_read_get_reconciliation_by_id_with_http_info(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_read_get_reconciliation_by_id_without_preload_content(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_bank_account_reconciliations_read_get_reconciliation_by_id_serialize(
        self,
        bank_account_id,
        reconciliation_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/bankaccounts/{bankAccountId}/reconciliations/{reconciliationId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_read_get_reconciliations(
        self,
        bank_account_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[BankAccountReconciliationMessage]:
        ...
        _param = self._external_api_bank_account_reconciliations_read_get_reconciliations_serialize(
            bank_account_id=bank_account_id,
            orderby=orderby,
            offset=offset,
            limit=limit,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[BankAccountReconciliationMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_read_get_reconciliations_with_http_info(
        self,
        bank_account_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[BankAccountReconciliationMessage]]:
        """Retrieve all reconciliations
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_read_get_reconciliations_without_preload_content(
        self,
        bank_account_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
    ...
    def _external_api_bank_account_reconciliations_read_get_reconciliations_serialize(
        self,
        bank_account_id,
        orderby,
        offset,
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_write_clear_transactions(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        bank_reconciliation_clear_transactions_post_message: BankReconciliationClearTransactionsPostMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param reconciliation_id: (required)
        :type reconciliation_id: int
        :param bank_reconciliation_clear_transactions_post_message: (required)
        :type bank_reconciliation_clear_transactions_post_message: BankReconciliationClearTransactionsPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_bank_account_reconciliations_write_clear_transactions_serialize(
            bank_account_id=bank_account_id,
            reconciliation_id=reconciliation_id,
            bank_reconciliation_clear_transactions_post_message=bank_reconciliation_clear_transactions_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_write_clear_transactions_with_http_info(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        bank_reconciliation_clear_transactions_post_message: BankReconciliationClearTransactionsPostMessage,
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_write_clear_transactions_without_preload_content(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        bank_reconciliation_clear_transactions_post_message: BankReconciliationClearTransactionsPostMessage,
    ...
    def _external_api_bank_account_reconciliations_write_clear_transactions_serialize(
        self,
        bank_account_id,
        reconciliation_id,
        bank_reconciliation_clear_transactions_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if bank_reconciliation_clear_transactions_post_message is not None:
            _body_params = bank_reconciliation_clear_transactions_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/bankaccounts/{bankAccountId}/reconciliations/{reconciliationId}/cleartransactionsrequest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_write_unclear_transactions(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        bank_reconciliation_unclear_transactions_post_message: BankReconciliationUnclearTransactionsPostMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param reconciliation_id: (required)
        :type reconciliation_id: int
        :param bank_reconciliation_unclear_transactions_post_message: (required)
        :type bank_reconciliation_unclear_transactions_post_message: BankReconciliationUnclearTransactionsPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_bank_account_reconciliations_write_unclear_transactions_serialize(
            bank_account_id=bank_account_id,
            reconciliation_id=reconciliation_id,
            bank_reconciliation_unclear_transactions_post_message=bank_reconciliation_unclear_transactions_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_write_unclear_transactions_with_http_info(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        bank_reconciliation_unclear_transactions_post_message: BankReconciliationUnclearTransactionsPostMessage,
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_write_unclear_transactions_without_preload_content(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        bank_reconciliation_unclear_transactions_post_message: BankReconciliationUnclearTransactionsPostMessage,
    ...
    def _external_api_bank_account_reconciliations_write_unclear_transactions_serialize(
        self,
        bank_account_id,
        reconciliation_id,
        bank_reconciliation_unclear_transactions_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if bank_reconciliation_unclear_transactions_post_message is not None:
            _body_params = bank_reconciliation_unclear_transactions_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/bankaccounts/{bankAccountId}/reconciliations/{reconciliationId}/uncleartransactionsrequest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_write_update_reconciliation(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        bank_reconciliation_put_message: BankReconciliationPutMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param reconciliation_id: (required)
        :type reconciliation_id: int
        :param bank_reconciliation_put_message: (required)
        :type bank_reconciliation_put_message: BankReconciliationPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_bank_account_reconciliations_write_update_reconciliation_serialize(
            bank_account_id=bank_account_id,
            reconciliation_id=reconciliation_id,
            bank_reconciliation_put_message=bank_reconciliation_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_write_update_reconciliation_with_http_info(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        bank_reconciliation_put_message: BankReconciliationPutMessage,
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_write_update_reconciliation_without_preload_content(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        bank_reconciliation_put_message: BankReconciliationPutMessage,
    ...
    def _external_api_bank_account_reconciliations_write_update_reconciliation_serialize(
        self,
        bank_account_id,
        reconciliation_id,
        bank_reconciliation_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if bank_reconciliation_put_message is not None:
            _body_params = bank_reconciliation_put_message
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_write_update_reconciliation_balances(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        bank_account_reconciliation_balance_put_message: BankAccountReconciliationBalancePutMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param reconciliation_id: (required)
        :type reconciliation_id: int
        :param bank_account_reconciliation_balance_put_message: (required)
        :type bank_account_reconciliation_balance_put_message: BankAccountReconciliationBalancePutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_bank_account_reconciliations_write_update_reconciliation_balances_serialize(
            bank_account_id=bank_account_id,
            reconciliation_id=reconciliation_id,
            bank_account_reconciliation_balance_put_message=bank_account_reconciliation_balance_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_write_update_reconciliation_balances_with_http_info(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        bank_account_reconciliation_balance_put_message: BankAccountReconciliationBalancePutMessage,
    ...
    @validate_call
    async def external_api_bank_account_reconciliations_write_update_reconciliation_balances_without_preload_content(
        self,
        bank_account_id: StrictInt,
        reconciliation_id: StrictInt,
        bank_account_reconciliation_balance_put_message: BankAccountReconciliationBalancePutMessage,
    ...
    def _external_api_bank_account_reconciliations_write_update_reconciliation_balances_serialize(
        self,
        bank_account_id,
        reconciliation_id,
        bank_account_reconciliation_balance_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if bank_account_reconciliation_balance_put_message is not None:
            _body_params = bank_account_reconciliation_balance_put_message
    ...
    @validate_call
    async def external_api_bank_account_transactions_get_bank_account_transaction_by_id(
        self,
        bank_account_id: StrictInt,
        ...
        _param = self._external_api_bank_account_transactions_get_bank_account_transaction_by_id_serialize(
            bank_account_id=bank_account_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BankAccountTransactionMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_transactions_get_bank_account_transaction_by_id_with_http_info(
        self,
        bank_account_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BankAccountTransactionMessage]:
        """Retrieve a transaction
    ...
    @validate_call
    async def external_api_bank_account_transactions_get_bank_account_transaction_by_id_without_preload_content(
        self,
        bank_account_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_bank_account_transactions_get_bank_account_transaction_by_id_serialize(
        self,
        bank_account_id,
        transaction_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/bankaccounts/{bankAccountId}/transactions/{transactionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_transactions_get_bank_account_transactions(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[BankAccountTransactionMessage]:
        ...
        _param = self._external_api_bank_account_transactions_get_bank_account_transactions_serialize(
            bank_account_id=bank_account_id,
            startdate=startdate,
            enddate=enddate,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[BankAccountTransactionMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_transactions_get_bank_account_transactions_with_http_info(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[BankAccountTransactionMessage]]:
        """Retrieve all transactions
    ...
    @validate_call
    async def external_api_bank_account_transactions_get_bank_account_transactions_without_preload_content(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
    ...
    def _external_api_bank_account_transactions_get_bank_account_transactions_serialize(
        self,
        bank_account_id,
        startdate,
        enddate,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/bankaccounts/{bankAccountId}/transactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_transfers_create_bank_account_transfer(
        self,
        bank_account_id: StrictInt,
        ...
        :param bank_account_id: (required)
        :type bank_account_id: int
        :param bank_account_transfer_save_message: (required)
        :type bank_account_transfer_save_message: BankAccountTransferSaveMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_bank_account_transfers_create_bank_account_transfer_serialize(
            bank_account_id=bank_account_id,
            bank_account_transfer_save_message=bank_account_transfer_save_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "BankAccountTransferMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_transfers_create_bank_account_transfer_with_http_info(
        self,
        bank_account_id: StrictInt,
        bank_account_transfer_save_message: BankAccountTransferSaveMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BankAccountTransferMessage]:
        """Create a transfer
    ...
    @validate_call
    async def external_api_bank_account_transfers_create_bank_account_transfer_without_preload_content(
        self,
        bank_account_id: StrictInt,
        bank_account_transfer_save_message: BankAccountTransferSaveMessage,
        _request_timeout: Union[
    ...
    def _external_api_bank_account_transfers_create_bank_account_transfer_serialize(
        self,
        bank_account_id,
        bank_account_transfer_save_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if bank_account_transfer_save_message is not None:
            _body_params = bank_account_transfer_save_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/bankaccounts/{bankAccountId}/transfers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_transfers_get_bank_account_transfer_by_id(
        self,
        bank_account_id: Annotated[StrictInt, Field(description="The bank account identifier.")],
        transfer_id: Annotated[StrictInt, Field(description="The transfer identifier.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param bank_account_id: The bank account identifier. (required)
        :type bank_account_id: int
        :param transfer_id: The transfer identifier. (required)
        ...
        _param = self._external_api_bank_account_transfers_get_bank_account_transfer_by_id_serialize(
            bank_account_id=bank_account_id,
    ...
    @validate_call
    async def external_api_bank_account_transfers_get_bank_account_transfer_by_id_with_http_info(
        self,
        bank_account_id: Annotated[StrictInt, Field(description="The bank account identifier.")],
        transfer_id: Annotated[StrictInt, Field(description="The transfer identifier.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BankAccountMessage]:
        """Retrieve a transfer
    ...
    @validate_call
    async def external_api_bank_account_transfers_get_bank_account_transfer_by_id_without_preload_content(
        self,
        bank_account_id: Annotated[StrictInt, Field(description="The bank account identifier.")],
        transfer_id: Annotated[StrictInt, Field(description="The transfer identifier.")],
        _request_timeout: Union[
    ...
    def _external_api_bank_account_transfers_get_bank_account_transfer_by_id_serialize(
        self,
        bank_account_id,
        transfer_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/bankaccounts/{bankAccountId}/transfers/{transferId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_transfers_get_bank_account_transfers(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any transfers that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any transfers that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[BankAccountTransferMessage]:
        ...
        :param bank_account_id: (required)
        :type bank_account_id: int
        :param startdate: Filters results to any transfers that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD. (required)
        :type startdate: date
        :param enddate: Filters results to any transfers that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD. (required)
        :type enddate: date
        :param orderby: `orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.
        :type orderby: str
        :param offset: `offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.
        ...
        _param = self._external_api_bank_account_transfers_get_bank_account_transfers_serialize(
            bank_account_id=bank_account_id,
            startdate=startdate,
            enddate=enddate,
            orderby=orderby,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[BankAccountTransferMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_transfers_get_bank_account_transfers_with_http_info(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any transfers that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any transfers that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[BankAccountTransferMessage]]:
        """Retrieve all transfers
    ...
    @validate_call
    async def external_api_bank_account_transfers_get_bank_account_transfers_without_preload_content(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any transfers that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any transfers that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
    ...
    def _external_api_bank_account_transfers_get_bank_account_transfers_serialize(
        self,
        bank_account_id,
        startdate,
        enddate,
    ...
    @validate_call
    async def external_api_bank_account_transfers_update_bank_account_transfer(
        self,
        bank_account_id: StrictInt,
        ...
        _param = self._external_api_bank_account_transfers_update_bank_account_transfer_serialize(
            bank_account_id=bank_account_id,
            transfer_id=transfer_id,
            bank_account_transfer_save_message=bank_account_transfer_save_message,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BankAccountTransferMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_transfers_update_bank_account_transfer_with_http_info(
        self,
        bank_account_id: StrictInt,
        transfer_id: StrictInt,
        bank_account_transfer_save_message: BankAccountTransferSaveMessage,
    ...
    @validate_call
    async def external_api_bank_account_transfers_update_bank_account_transfer_without_preload_content(
        self,
        bank_account_id: StrictInt,
        transfer_id: StrictInt,
        bank_account_transfer_save_message: BankAccountTransferSaveMessage,
    ...
    def _external_api_bank_account_transfers_update_bank_account_transfer_serialize(
        self,
        bank_account_id,
        transfer_id,
        bank_account_transfer_save_message,
    ...
    @validate_call
    async def external_api_bank_account_undeposited_funds_get_undeposited_funds(
        self,
        bank_account_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        ...
        _param = self._external_api_bank_account_undeposited_funds_get_undeposited_funds_serialize(
            bank_account_id=bank_account_id,
            orderby=orderby,
            offset=offset,
            limit=limit,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[UndepositedFundsMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_undeposited_funds_get_undeposited_funds_with_http_info(
        self,
        bank_account_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[UndepositedFundsMessage]]:
        """Retrieve all undeposited funds
    ...
    @validate_call
    async def external_api_bank_account_undeposited_funds_get_undeposited_funds_without_preload_content(
        self,
        bank_account_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
    ...
    def _external_api_bank_account_undeposited_funds_get_undeposited_funds_serialize(
        self,
        bank_account_id,
        orderby,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/bankaccounts/{bankAccountId}/undepositedfunds',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_withdrawals_create_withdrawal_for_bank_account(
        self,
        bank_account_id: StrictInt,
        ...
        :param bank_account_id: (required)
        :type bank_account_id: int
        :param bank_account_withdrawal_save_message: (required)
        :type bank_account_withdrawal_save_message: BankAccountWithdrawalSaveMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_bank_account_withdrawals_create_withdrawal_for_bank_account_serialize(
            bank_account_id=bank_account_id,
            bank_account_withdrawal_save_message=bank_account_withdrawal_save_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "BankAccountWithdrawalMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_withdrawals_create_withdrawal_for_bank_account_with_http_info(
        self,
        bank_account_id: StrictInt,
        bank_account_withdrawal_save_message: BankAccountWithdrawalSaveMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BankAccountWithdrawalMessage]:
        """Create a withdrawal
    ...
    @validate_call
    async def external_api_bank_account_withdrawals_create_withdrawal_for_bank_account_without_preload_content(
        self,
        bank_account_id: StrictInt,
        bank_account_withdrawal_save_message: BankAccountWithdrawalSaveMessage,
        _request_timeout: Union[
    ...
    def _external_api_bank_account_withdrawals_create_withdrawal_for_bank_account_serialize(
        self,
        bank_account_id,
        bank_account_withdrawal_save_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if bank_account_withdrawal_save_message is not None:
            _body_params = bank_account_withdrawal_save_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/bankaccounts/{bankAccountId}/withdrawals',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_withdrawals_get_bank_account_withdrawal_by_id(
        self,
        bank_account_id: StrictInt,
        withdrawal_id: StrictInt,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._external_api_bank_account_withdrawals_get_bank_account_withdrawal_by_id_serialize(
            bank_account_id=bank_account_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BankAccountWithdrawalMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_withdrawals_get_bank_account_withdrawal_by_id_with_http_info(
        self,
        bank_account_id: StrictInt,
        withdrawal_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_bank_account_withdrawals_get_bank_account_withdrawal_by_id_without_preload_content(
        self,
        bank_account_id: StrictInt,
        withdrawal_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_bank_account_withdrawals_get_bank_account_withdrawal_by_id_serialize(
        self,
        bank_account_id,
        withdrawal_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/bankaccounts/{bankAccountId}/withdrawals/{withdrawalId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_account_withdrawals_get_bank_account_withdrawals(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[BankAccountWithdrawalMessage]:
        ...
        _param = self._external_api_bank_account_withdrawals_get_bank_account_withdrawals_serialize(
            bank_account_id=bank_account_id,
            startdate=startdate,
            enddate=enddate,
            orderby=orderby,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[BankAccountWithdrawalMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_bank_account_withdrawals_get_bank_account_withdrawals_with_http_info(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[BankAccountWithdrawalMessage]]:
        """Retrieve all withdrawals
    ...
    @validate_call
    async def external_api_bank_account_withdrawals_get_bank_account_withdrawals_without_preload_content(
        self,
        bank_account_id: StrictInt,
        startdate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or after the specified date. The value must be formatted as YYYY-MM-DD.")],
        enddate: Annotated[date, Field(description="Filters results to any transactions that were recorded on or before the specified date. The value must be formatted as YYYY-MM-DD.")],
    ...
    def _external_api_bank_account_withdrawals_get_bank_account_withdrawals_serialize(
        self,
        bank_account_id,
        startdate,
        enddate,
    ...
    @validate_call
    async def external_api_bank_account_withdrawals_update_bank_account_withdrawal(
        self,
        bank_account_id: StrictInt,
        withdrawal_id: StrictInt,
        bank_account_withdrawal_save_message: BankAccountWithdrawalSaveMessage,
        ...
        _param = self._external_api_bank_account_withdrawals_update_bank_account_withdrawal_serialize(
            bank_account_id=bank_account_id,
            withdrawal_id=withdrawal_id,
            bank_account_withdrawal_save_message=bank_account_withdrawal_save_message,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def external_api_bank_account_withdrawals_update_bank_account_withdrawal_with_http_info(
        self,
        bank_account_id: StrictInt,
        withdrawal_id: StrictInt,
        bank_account_withdrawal_save_message: BankAccountWithdrawalSaveMessage,
    ...
    @validate_call
    async def external_api_bank_account_withdrawals_update_bank_account_withdrawal_without_preload_content(
        self,
        bank_account_id: StrictInt,
        withdrawal_id: StrictInt,
        bank_account_withdrawal_save_message: BankAccountWithdrawalSaveMessage,
    ...
    def _external_api_bank_account_withdrawals_update_bank_account_withdrawal_serialize(
        self,
        bank_account_id,
        withdrawal_id,
        bank_account_withdrawal_save_message,
    ...
    @validate_call
    async def external_api_bank_accounts_create_bank_account(
        self,
        ...
        :param bank_account_post_message: (required)
        :type bank_account_post_message: BankAccountPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_bank_accounts_create_bank_account_serialize(
            bank_account_post_message=bank_account_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_bank_accounts_create_bank_account_with_http_info(
        self,
        bank_account_post_message: BankAccountPostMessage,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def external_api_bank_accounts_create_bank_account_without_preload_content(
        self,
        bank_account_post_message: BankAccountPostMessage,
        _request_timeout: Union[
            None,
    ...
    def _external_api_bank_accounts_create_bank_account_serialize(
        self,
        ...
        # process the form parameters
        # process the body parameter
        if bank_account_post_message is not None:
            _body_params = bank_account_post_message
    ...
    async def external_api_bank_accounts_get_all_bank_accounts(
        self,
        bankaccountstatus: Annotated[Optional[StrictStr], Field(description="Filters results by the status of the bank account. If no status is specified, bank accounts with any status will be returned.")] = None,
        bankname: Annotated[Optional[StrictStr], Field(description="Filters results to any bank account whose name *contains* the specified value.")] = None,
        routingnumbers: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any bank accounts whose routing number *contains* the specified value.")] = None,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
        _request_timeout: Union[
        ...
        :param bankaccountstatus: Filters results by the status of the bank account. If no status is specified, bank accounts with any status will be returned.
        :type bankaccountstatus: str
        :param bankname: Filters results to any bank account whose name *contains* the specified value.
        :type bankname: str
        :param routingnumbers: Filters results to any bank accounts whose routing number *contains* the specified value.
        :type routingnumbers: List[str]
        :param orderby: `orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.
        :type orderby: str
        :param offset: `offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.
        :type offset: int
        ...
        _param = self._external_api_bank_accounts_get_all_bank_accounts_serialize(
    ...
    @validate_call
    async def external_api_bank_accounts_get_all_bank_accounts_with_http_info(
        self,
        bankaccountstatus: Annotated[Optional[StrictStr], Field(description="Filters results by the status of the bank account. If no status is specified, bank accounts with any status will be returned.")] = None,
        bankname: Annotated[Optional[StrictStr], Field(description="Filters results to any bank account whose name *contains* the specified value.")] = None,
        routingnumbers: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any bank accounts whose routing number *contains* the specified value.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[BankAccountMessage]]:
        """Retrieve all bank accounts
    ...
    @validate_call
    async def external_api_bank_accounts_get_all_bank_accounts_without_preload_content(
        self,
        bankaccountstatus: Annotated[Optional[StrictStr], Field(description="Filters results by the status of the bank account. If no status is specified, bank accounts with any status will be returned.")] = None,
        bankname: Annotated[Optional[StrictStr], Field(description="Filters results to any bank account whose name *contains* the specified value.")] = None,
        routingnumbers: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any bank accounts whose routing number *contains* the specified value.")] = None,
    ...
    def _external_api_bank_accounts_get_all_bank_accounts_serialize(
        self,
        bankaccountstatus,
        bankname,
        routingnumbers,
        ...
        # process the path parameters
        # process the query parameters
        if bankaccountstatus is not None:
            
            _query_params.append(('bankaccountstatus', bankaccountstatus))
            
        if bankname is not None:
            
            _query_params.append(('bankname', bankname))
            
        if routingnumbers is not None:
            
            _query_params.append(('routingnumbers', routingnumbers))
    ...
    @validate_call
    async def external_api_bank_accounts_get_bank_account(
        self,
        bank_account_id: Annotated[StrictInt, Field(description="The bank account identifier.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._external_api_bank_accounts_get_bank_account_serialize(
            bank_account_id=bank_account_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def external_api_bank_accounts_get_bank_account_with_http_info(
        self,
        bank_account_id: Annotated[StrictInt, Field(description="The bank account identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def external_api_bank_accounts_get_bank_account_without_preload_content(
        self,
        bank_account_id: Annotated[StrictInt, Field(description="The bank account identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _external_api_bank_accounts_get_bank_account_serialize(
        self,
        bank_account_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/bankaccounts/{bankAccountId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_bank_accounts_update_bank_account(
        self,
        bank_account_id: StrictInt,
        ...
        :param bank_account_id: (required)
        :type bank_account_id: int
        :param bank_account_put_message: (required)
        :type bank_account_put_message: BankAccountPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_bank_accounts_update_bank_account_serialize(
            bank_account_id=bank_account_id,
            bank_account_put_message=bank_account_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_bank_accounts_update_bank_account_with_http_info(
        self,
        bank_account_id: StrictInt,
        bank_account_put_message: BankAccountPutMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_bank_accounts_update_bank_account_without_preload_content(
        self,
        bank_account_id: StrictInt,
        bank_account_put_message: BankAccountPutMessage,
        _request_timeout: Union[
    ...
    def _external_api_bank_accounts_update_bank_account_serialize(
        self,
        bank_account_id,
        bank_account_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if bank_account_put_message is not None:
            _body_params = bank_account_put_message
