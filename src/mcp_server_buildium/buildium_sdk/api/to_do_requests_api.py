...
from mcp_server_buildium.buildium_sdk.models.to_do_task_post_message import ToDoTaskPostMessage
from mcp_server_buildium.buildium_sdk.models.to_do_task_put_message import ToDoTaskPutMessage
...
class ToDoRequestsApi:
    ...
    @validate_call
    async def external_api_to_do_tasks_create_to_do_task(
        self,
        ...
        :param to_do_task_post_message: (required)
        :type to_do_task_post_message: ToDoTaskPostMessage
        ...
        _param = self._external_api_to_do_tasks_create_to_do_task_serialize(
            to_do_task_post_message=to_do_task_post_message,
    ...
    @validate_call
    async def external_api_to_do_tasks_create_to_do_task_with_http_info(
        self,
        to_do_task_post_message: ToDoTaskPostMessage,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def external_api_to_do_tasks_create_to_do_task_without_preload_content(
        self,
        to_do_task_post_message: ToDoTaskPostMessage,
        _request_timeout: Union[
            None,
    ...
    def _external_api_to_do_tasks_create_to_do_task_serialize(
        self,
        ...
        if to_do_task_post_message is not None:
            _body_params = to_do_task_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/tasks/todorequests',
    ...
    @validate_call
    async def external_api_to_do_tasks_get_to_do_task_by_id(
        self,
        to_do_task_id: Annotated[StrictInt, Field(description="The to do task identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param to_do_task_id: The to do task identifier (required)
        :type to_do_task_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_to_do_tasks_get_to_do_task_by_id_serialize(
    ...
    @validate_call
    async def external_api_to_do_tasks_get_to_do_task_by_id_with_http_info(
        self,
        to_do_task_id: Annotated[StrictInt, Field(description="The to do task identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def external_api_to_do_tasks_get_to_do_task_by_id_without_preload_content(
        self,
        to_do_task_id: Annotated[StrictInt, Field(description="The to do task identifier")],
        _request_timeout: Union[
            None,
    ...
    def _external_api_to_do_tasks_get_to_do_task_by_id_serialize(
        self,
        to_do_task_id,
        _request_auth,
        _content_type,
        ...
        # process the path parameters
        if to_do_task_id is not None:
            _path_params['toDoTaskId'] = to_do_task_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/tasks/todorequests/{toDoTaskId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_to_do_tasks_get_to_do_tasks(
        self,
        ...
        _param = self._external_api_to_do_tasks_get_to_do_tasks_serialize(
    ...
    @validate_call
    async def external_api_to_do_tasks_get_to_do_tasks_with_http_info(
        self,
        entitytype: Annotated[Optional[StrictStr], Field(description="Specifies the type of entity that the `EntityId` field refers to. This field is required if the `EntityId` field is populated.")] = None,
        entityid: Annotated[Optional[StrictInt], Field(description="Filters results to any task associated with the specified entity id value. The value must be of the type specified in the `EntityType` field.")] = None,
        statuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results by the status of the task. If no status is specified, tasks with any status will be returned.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ToDoTaskMessage]]:
        """Retrieve all to do requests
    ...
    @validate_call
    async def external_api_to_do_tasks_get_to_do_tasks_without_preload_content(
        self,
        entitytype: Annotated[Optional[StrictStr], Field(description="Specifies the type of entity that the `EntityId` field refers to. This field is required if the `EntityId` field is populated.")] = None,
        entityid: Annotated[Optional[StrictInt], Field(description="Filters results to any task associated with the specified entity id value. The value must be of the type specified in the `EntityType` field.")] = None,
        statuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results by the status of the task. If no status is specified, tasks with any status will be returned.")] = None,
    ...
    def _external_api_to_do_tasks_get_to_do_tasks_serialize(
        self,
        entitytype,
        entityid,
        statuses,
    ...
    @validate_call
    async def external_api_to_do_tasks_update_to_do_task(
        self,
        to_do_task_id: Annotated[StrictInt, Field(description="The to do task identifier.")],
        ...
        :param to_do_task_id: The to do task identifier. (required)
        :type to_do_task_id: int
        :param to_do_task_put_message: (required)
        :type to_do_task_put_message: ToDoTaskPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_to_do_tasks_update_to_do_task_serialize(
            to_do_task_id=to_do_task_id,
            to_do_task_put_message=to_do_task_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_to_do_tasks_update_to_do_task_with_http_info(
        self,
        to_do_task_id: Annotated[StrictInt, Field(description="The to do task identifier.")],
        to_do_task_put_message: ToDoTaskPutMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_to_do_tasks_update_to_do_task_without_preload_content(
        self,
        to_do_task_id: Annotated[StrictInt, Field(description="The to do task identifier.")],
        to_do_task_put_message: ToDoTaskPutMessage,
        _request_timeout: Union[
    ...
    def _external_api_to_do_tasks_update_to_do_task_serialize(
        self,
        to_do_task_id,
        to_do_task_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if to_do_task_put_message is not None:
            _body_params = to_do_task_put_message
