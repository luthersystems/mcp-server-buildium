...
class TasksApi:
    ...
    @validate_call
    async def external_api_task_categories_create_task_category(
        self,
        task_category_save_message: TaskCategorySaveMessage,
        ...
        :param task_category_save_message: (required)
        :type task_category_save_message: TaskCategorySaveMessage
        ...
        _param = self._external_api_task_categories_create_task_category_serialize(
            task_category_save_message=task_category_save_message,
    ...
    @validate_call
    async def external_api_task_categories_create_task_category_with_http_info(
        self,
        task_category_save_message: TaskCategorySaveMessage,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TaskCategoryMessage]:
        """Create a task category
    ...
    @validate_call
    async def external_api_task_categories_create_task_category_without_preload_content(
        self,
        task_category_save_message: TaskCategorySaveMessage,
        _request_timeout: Union[
            None,
    ...
    def _external_api_task_categories_create_task_category_serialize(
        self,
        ...
        if task_category_save_message is not None:
            _body_params = task_category_save_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/tasks/categories',
    ...
    @validate_call
    async def external_api_task_categories_get_all_task_categories(
        self,
        ...
        _param = self._external_api_task_categories_get_all_task_categories_serialize(
            orderby=orderby,
            offset=offset,
            limit=limit,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def external_api_task_categories_get_all_task_categories_with_http_info(
        self,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[TaskCategoryMessage]]:
        """Retrieve all task categories
    ...
    @validate_call
    async def external_api_task_categories_get_all_task_categories_without_preload_content(
        self,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
    ...
    def _external_api_task_categories_get_all_task_categories_serialize(
        self,
        orderby,
        offset,
        limit,
    ...
    @validate_call
    async def external_api_task_categories_get_task_category_by_id(
        self,
        task_category_id: Annotated[StrictInt, Field(description="The task category identifier.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param task_category_id: The task category identifier. (required)
        :type task_category_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_task_categories_get_task_category_by_id_serialize(
    ...
    @validate_call
    async def external_api_task_categories_get_task_category_by_id_with_http_info(
        self,
        task_category_id: Annotated[StrictInt, Field(description="The task category identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def external_api_task_categories_get_task_category_by_id_without_preload_content(
        self,
        task_category_id: Annotated[StrictInt, Field(description="The task category identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _external_api_task_categories_get_task_category_by_id_serialize(
        self,
        task_category_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/tasks/categories/{taskCategoryId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_task_categories_update_task_category(
        self,
        task_category_id: Annotated[StrictInt, Field(description="The task category identifier.")],
        ...
        :param task_category_id: The task category identifier. (required)
        :type task_category_id: int
        :param task_category_put_message: (required)
        :type task_category_put_message: TaskCategoryPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_task_categories_update_task_category_serialize(
            task_category_id=task_category_id,
            task_category_put_message=task_category_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_task_categories_update_task_category_with_http_info(
        self,
        task_category_id: Annotated[StrictInt, Field(description="The task category identifier.")],
        task_category_put_message: TaskCategoryPutMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_task_categories_update_task_category_without_preload_content(
        self,
        task_category_id: Annotated[StrictInt, Field(description="The task category identifier.")],
        task_category_put_message: TaskCategoryPutMessage,
        _request_timeout: Union[
    ...
    def _external_api_task_categories_update_task_category_serialize(
        self,
        task_category_id,
        task_category_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if task_category_put_message is not None:
            _body_params = task_category_put_message
    ...
    @validate_call
    async def external_api_task_history_file_downloads_get_file_download_request(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        file_id: StrictInt,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :type task_id: int
        :param task_history_id: (required)
        ...
        _param = self._external_api_task_history_file_downloads_get_file_download_request_serialize(
            task_id=task_id,
    ...
    @validate_call
    async def external_api_task_history_file_downloads_get_file_download_request_with_http_info(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        file_id: StrictInt,
    ...
    @validate_call
    async def external_api_task_history_file_downloads_get_file_download_request_without_preload_content(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        file_id: StrictInt,
    ...
    def _external_api_task_history_file_downloads_get_file_download_request_serialize(
        self,
        task_id,
        task_history_id,
        file_id,
        ...
        if task_history_id is not None:
            _path_params['taskHistoryId'] = task_history_id
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/tasks/{taskId}/history/{taskHistoryId}/files/{fileId}/downloadrequest',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_task_history_file_uploads_create_upload_file_request_async(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        ...
        _param = self._external_api_task_history_file_uploads_create_upload_file_request_async_serialize(
            task_id=task_id,
            task_history_id=task_history_id,
            task_history_file_upload_post_message=task_history_file_upload_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_task_history_file_uploads_create_upload_file_request_async_with_http_info(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        task_history_file_upload_post_message: TaskHistoryFileUploadPostMessage,
    ...
    @validate_call
    async def external_api_task_history_file_uploads_create_upload_file_request_async_without_preload_content(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        task_history_file_upload_post_message: TaskHistoryFileUploadPostMessage,
    ...
    def _external_api_task_history_file_uploads_create_upload_file_request_async_serialize(
        self,
        task_id,
        task_history_id,
        task_history_file_upload_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if task_history_file_upload_post_message is not None:
            _body_params = task_history_file_upload_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/tasks/{taskId}/history/{taskHistoryId}/files/uploadrequests',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_task_history_files_delete_task_history_file(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        file_id: StrictInt,
        ...
        _param = self._external_api_task_history_files_delete_task_history_file_serialize(
            task_id=task_id,
            task_history_id=task_history_id,
            file_id=file_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def external_api_task_history_files_delete_task_history_file_with_http_info(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        file_id: StrictInt,
    ...
    @validate_call
    async def external_api_task_history_files_delete_task_history_file_without_preload_content(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        file_id: StrictInt,
    ...
    def _external_api_task_history_files_delete_task_history_file_serialize(
        self,
        task_id,
        task_history_id,
        file_id,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/tasks/{taskId}/history/{taskHistoryId}/files/{fileId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_task_history_files_get_all_task_history_files(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        ...
        _param = self._external_api_task_history_files_get_all_task_history_files_serialize(
            task_id=task_id,
            task_history_id=task_history_id,
            orderby=orderby,
            offset=offset,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[TaskHistoryFileMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_task_history_files_get_all_task_history_files_with_http_info(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[TaskHistoryFileMessage]]:
        """Retrieve all task history files
    ...
    @validate_call
    async def external_api_task_history_files_get_all_task_history_files_without_preload_content(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
    ...
    def _external_api_task_history_files_get_all_task_history_files_serialize(
        self,
        task_id,
        task_history_id,
        orderby,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/tasks/{taskId}/history/{taskHistoryId}/files',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_task_history_files_get_task_history_file_by_id(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        file_id: StrictInt,
        ...
        _param = self._external_api_task_history_files_get_task_history_file_by_id_serialize(
            task_id=task_id,
            task_history_id=task_history_id,
            file_id=file_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def external_api_task_history_files_get_task_history_file_by_id_with_http_info(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        file_id: StrictInt,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TaskHistoryFileMessage]:
        """Retrieve a task history file
    ...
    @validate_call
    async def external_api_task_history_files_get_task_history_file_by_id_without_preload_content(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        file_id: StrictInt,
    ...
    def _external_api_task_history_files_get_task_history_file_by_id_serialize(
        self,
        task_id,
        task_history_id,
        file_id,
    ...
    @validate_call
    async def external_api_task_history_get_task_histories(
        self,
        task_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        ...
        _param = self._external_api_task_history_get_task_histories_serialize(
            task_id=task_id,
            orderby=orderby,
            offset=offset,
            limit=limit,
    ...
    @validate_call
    async def external_api_task_history_get_task_histories_with_http_info(
        self,
        task_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[TaskHistoryMessage]]:
        """Retrieve all task history
    ...
    @validate_call
    async def external_api_task_history_get_task_histories_without_preload_content(
        self,
        task_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
    ...
    def _external_api_task_history_get_task_histories_serialize(
        self,
        task_id,
        orderby,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/tasks/{taskId}/history',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_task_history_get_task_history_by_id(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_task_history_get_task_history_by_id_serialize(
            task_id=task_id,
            task_history_id=task_history_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def external_api_task_history_get_task_history_by_id_with_http_info(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TaskHistoryMessage]:
        """Retrieve a task history
    ...
    @validate_call
    async def external_api_task_history_get_task_history_by_id_without_preload_content(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_task_history_get_task_history_by_id_serialize(
        self,
        task_id,
        task_history_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/tasks/{taskId}/history/{taskHistoryId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_task_history_update_task_history(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        ...
        :param task_history_id: (required)
        :type task_history_id: int
        :param task_history_put_message: (required)
        :type task_history_put_message: TaskHistoryPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_task_history_update_task_history_serialize(
            task_id=task_id,
            task_history_id=task_history_id,
            task_history_put_message=task_history_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_task_history_update_task_history_with_http_info(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        task_history_put_message: TaskHistoryPutMessage,
    ...
    @validate_call
    async def external_api_task_history_update_task_history_without_preload_content(
        self,
        task_id: StrictInt,
        task_history_id: StrictInt,
        task_history_put_message: TaskHistoryPutMessage,
    ...
    def _external_api_task_history_update_task_history_serialize(
        self,
        task_id,
        task_history_id,
        task_history_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if task_history_put_message is not None:
            _body_params = task_history_put_message
    ...
    @validate_call
    async def external_api_tasks_get_all_tasks(
        self,
        ...
        entityid: Annotated[Optional[StrictInt], Field(description="Filters results to any task associated with the specified entity id value. The value must be of the type specified in the `EntityType` field.")] = None,
        statuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results by the status of the task. If no status is specified, tasks with any status will be returned.")] = None,
        type: Annotated[Optional[StrictStr], Field(description="Filters results to any task associated with the task type specified.")] = None,
        unitid: Annotated[Optional[StrictInt], Field(description="Filters results to any task associated with the unit identifier.")] = None,
        unitagreementid: Annotated[Optional[StrictInt], Field(description="Filters results to any task associated with the unit agreement identifier specified.")] = None,
        lastupdatedfrom: Annotated[Optional[date], Field(description="Filters results to any tasks were updated on or after the specified date. The value must be formatted as YYYY-MM-DD.")] = None,
        lastupdatedto: Annotated[Optional[date], Field(description="Filters results to any tasks were updated on or before the specified date. The value must be formatted as YYYY-MM-DD.")] = None,
        duedatefrom: Annotated[Optional[date], Field(description="Filters results to any tasks with a due date on or after the specified date. The value must be formatted as YYYY-MM-DD.")] = None,
        duedateto: Annotated[Optional[date], Field(description="Filters results to any tasks with a due date on or before the specified date. The value must be formatted as YYYY-MM-DD.")] = None,
        taskcategoryid: Annotated[Optional[StrictInt], Field(description="Filters results to any tasks with the specified category identifier.")] = None,
        priorities: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any tasks whose priority matches the specified values. If no priority is specified, tasks with any priority will be returned.")] = None,
        assignedtoid: Annotated[Optional[StrictInt], Field(description="Filters results to any tasks that have been assigned to the specified staff user identifier.")] = None,
        tasktitle: Annotated[Optional[StrictStr], Field(description="Filters results to any task whose title *contains* the specified value.")] = None,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
        _request_timeout: Union[
        ...
        :type entitytype: str
        :param entityid: Filters results to any task associated with the specified entity id value. The value must be of the type specified in the `EntityType` field.
        :type entityid: int
        :param statuses: Filters results by the status of the task. If no status is specified, tasks with any status will be returned.
        :type statuses: List[str]
        :param type: Filters results to any task associated with the task type specified.
        :type type: str
        :param unitid: Filters results to any task associated with the unit identifier.
        :type unitid: int
        :param unitagreementid: Filters results to any task associated with the unit agreement identifier specified.
        :type unitagreementid: int
        :param lastupdatedfrom: Filters results to any tasks were updated on or after the specified date. The value must be formatted as YYYY-MM-DD.
        :type lastupdatedfrom: date
        :param lastupdatedto: Filters results to any tasks were updated on or before the specified date. The value must be formatted as YYYY-MM-DD.
        :type lastupdatedto: date
        :param duedatefrom: Filters results to any tasks with a due date on or after the specified date. The value must be formatted as YYYY-MM-DD.
        :type duedatefrom: date
        :param duedateto: Filters results to any tasks with a due date on or before the specified date. The value must be formatted as YYYY-MM-DD.
        :type duedateto: date
        :param taskcategoryid: Filters results to any tasks with the specified category identifier.
        :type taskcategoryid: int
        :param priorities: Filters results to any tasks whose priority matches the specified values. If no priority is specified, tasks with any priority will be returned.
        :type priorities: List[str]
        :param assignedtoid: Filters results to any tasks that have been assigned to the specified staff user identifier.
        :type assignedtoid: int
        :param tasktitle: Filters results to any task whose title *contains* the specified value.
        :type tasktitle: str
        :param orderby: `orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.
        :type orderby: str
        :param offset: `offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.
        ...
        _param = self._external_api_tasks_get_all_tasks_serialize(
    ...
    @validate_call
    async def external_api_tasks_get_all_tasks_with_http_info(
        self,
        entitytype: Annotated[Optional[StrictStr], Field(description="Specifies the type of entity that the `EntityId` field refers to. This field is required if the `EntityId` field is populated.")] = None,
        entityid: Annotated[Optional[StrictInt], Field(description="Filters results to any task associated with the specified entity id value. The value must be of the type specified in the `EntityType` field.")] = None,
        statuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results by the status of the task. If no status is specified, tasks with any status will be returned.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[AllTasksMessage]]:
        """Retrieve all tasks
    ...
    @validate_call
    async def external_api_tasks_get_all_tasks_without_preload_content(
        self,
        entitytype: Annotated[Optional[StrictStr], Field(description="Specifies the type of entity that the `EntityId` field refers to. This field is required if the `EntityId` field is populated.")] = None,
        entityid: Annotated[Optional[StrictInt], Field(description="Filters results to any task associated with the specified entity id value. The value must be of the type specified in the `EntityType` field.")] = None,
        statuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results by the status of the task. If no status is specified, tasks with any status will be returned.")] = None,
    ...
    def _external_api_tasks_get_all_tasks_serialize(
        self,
        entitytype,
        entityid,
        statuses,
        ...
        if tasktitle is not None:
            ...
            _query_params.append(('tasktitle', tasktitle))
    ...
    @validate_call
    async def external_api_tasks_get_task_by_id(
        self,
        task_id: Annotated[StrictInt, Field(description="The task identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param task_id: The task identifier (required)
        :type task_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._external_api_tasks_get_task_by_id_serialize(
            task_id=task_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def external_api_tasks_get_task_by_id_with_http_info(
        self,
        task_id: Annotated[StrictInt, Field(description="The task identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def external_api_tasks_get_task_by_id_without_preload_content(
        self,
        task_id: Annotated[StrictInt, Field(description="The task identifier")],
        _request_timeout: Union[
            None,
    ...
    def _external_api_tasks_get_task_by_id_serialize(
        self,
        task_id,
        _request_auth,
        _content_type,
