...
class ResidentCenterApi:
    ...
    @validate_call
    async def external_api_resident_center_users_get_resident_center_users(
        self,
        unitagreementids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to any resident center user who is associated with the specified lease and/or association ownership account identifiers.")] = None,
        userids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to any resident center user with the specified tenant and/or association owner identifiers.")] = None,
        usertypes: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any resident center user with the specified types.")] = None,
        residentcenteruserstatuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any resident center user with the specified resident center user statuses.")] = None,
        isautopayenabled: Annotated[Optional[StrictBool], Field(description="If true, filters results to any resident center users who have automatic payments scheduled for the future. If false, filters results to any resident center users  who do not have automatic payments scheduled for the future. If not provided, will not filter results based on automatic payments.")] = None,
    ...
    ) -> List[ResidentCenterUserMessage]:
        ...
        :param unitagreementids: Filters results to any resident center user who is associated with the specified lease and/or association ownership account identifiers.
        :type unitagreementids: List[int]
        :param userids: Filters results to any resident center user with the specified tenant and/or association owner identifiers.
        :type userids: List[int]
        :param usertypes: Filters results to any resident center user with the specified types.
        :type usertypes: List[str]
        :param residentcenteruserstatuses: Filters results to any resident center user with the specified resident center user statuses.
        :type residentcenteruserstatuses: List[str]
        :param isautopayenabled: If true, filters results to any resident center users who have automatic payments scheduled for the future. If false, filters results to any resident center users  who do not have automatic payments scheduled for the future. If not provided, will not filter results based on automatic payments.
        :type isautopayenabled: bool
        ...
        _param = self._external_api_resident_center_users_get_resident_center_users_serialize(
            unitagreementids=unitagreementids,
            userids=userids,
            usertypes=usertypes,
            residentcenteruserstatuses=residentcenteruserstatuses,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[ResidentCenterUserMessage]",
    ...
    @validate_call
    async def external_api_resident_center_users_get_resident_center_users_with_http_info(
        self,
        unitagreementids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to any resident center user who is associated with the specified lease and/or association ownership account identifiers.")] = None,
        userids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to any resident center user with the specified tenant and/or association owner identifiers.")] = None,
        usertypes: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any resident center user with the specified types.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[ResidentCenterUserMessage]]:
        """Retrieve all resident center users
    ...
    @validate_call
    async def external_api_resident_center_users_get_resident_center_users_without_preload_content(
        self,
        unitagreementids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to any resident center user who is associated with the specified lease and/or association ownership account identifiers.")] = None,
        userids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to any resident center user with the specified tenant and/or association owner identifiers.")] = None,
        usertypes: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any resident center user with the specified types.")] = None,
    ...
    def _external_api_resident_center_users_get_resident_center_users_serialize(
        self,
        unitagreementids,
        userids,
        usertypes,
        ...
        _collection_formats: Dict[str, str] = {
            'unitagreementids': 'multi',
            'userids': 'multi',
            'usertypes': 'multi',
            'residentcenteruserstatuses': 'multi',
        }
        ...
        if unitagreementids is not None:
            
            _query_params.append(('unitagreementids', unitagreementids))
            
        if userids is not None:
            
            _query_params.append(('userids', userids))
            
        if usertypes is not None:
            
            _query_params.append(('usertypes', usertypes))
            
        if residentcenteruserstatuses is not None:
            
            _query_params.append(('residentcenteruserstatuses', residentcenteruserstatuses))
            
        if isautopayenabled is not None:
            
            _query_params.append(('isautopayenabled', isautopayenabled))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/residentCenterUsers',
    ...
    @validate_call
    async def external_api_retail_cash_read_get_retail_cash_user(
        self,
        user_id: StrictInt,
        unit_agreement_id: StrictInt,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type user_id: int
        :param unit_agreement_id: (required)
        :type unit_agreement_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_retail_cash_read_get_retail_cash_user_serialize(
            user_id=user_id,
            unit_agreement_id=unit_agreement_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_retail_cash_read_get_retail_cash_user_with_http_info(
        self,
        user_id: StrictInt,
        unit_agreement_id: StrictInt,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RetailCashUserMessage]:
        """Retrieve a retail cash user
    ...
    @validate_call
    async def external_api_retail_cash_read_get_retail_cash_user_without_preload_content(
        self,
        user_id: StrictInt,
        unit_agreement_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_retail_cash_read_get_retail_cash_user_serialize(
        self,
        user_id,
        unit_agreement_id,
        _request_auth,
        ...
        if unit_agreement_id is not None:
            _path_params['unitAgreementId'] = unit_agreement_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/retailcashusers/{userId}/{unitAgreementId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_retail_cash_read_get_retail_cash_users(
        self,
        entityid: Annotated[Optional[StrictInt], Field(description="Filters results to any users associated with the specified entity id value. The value must be of the type specified in the `EntityType` field.")] = None,
        ...
        statuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any users whose lease is in one of the provided statuses.")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Filters results to any users whose name *contains* the specified value.")] = None,
        unitaddress: Annotated[Optional[StrictStr], Field(description="Filters results to any users whose unit address *contains* the specified value.")] = None,
        isaccountcreated: Annotated[Optional[StrictBool], Field(description="Filters results to any users whose retail cash account is created.")] = None,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
        _request_timeout: Union[
        ...
        :param entityid: Filters results to any users associated with the specified entity id value. The value must be of the type specified in the `EntityType` field.
        :type entityid: int
        ...
        :type entitytype: str
        :param statuses: Filters results to any users whose lease is in one of the provided statuses.
        :type statuses: List[str]
        :param name: Filters results to any users whose name *contains* the specified value.
        :type name: str
        :param unitaddress: Filters results to any users whose unit address *contains* the specified value.
        :type unitaddress: str
        :param isaccountcreated: Filters results to any users whose retail cash account is created.
        :type isaccountcreated: bool
        :param orderby: `orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.
        :type orderby: str
        :param offset: `offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.
        :type offset: int
        ...
        _param = self._external_api_retail_cash_read_get_retail_cash_users_serialize(
            entityid=entityid,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RetailCashUserMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '422': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_retail_cash_read_get_retail_cash_users_with_http_info(
        self,
        entityid: Annotated[Optional[StrictInt], Field(description="Filters results to any users associated with the specified entity id value. The value must be of the type specified in the `EntityType` field.")] = None,
        entitytype: Annotated[Optional[StrictStr], Field(description="Specifies the type of entity that the `EntityId` field refers to. This field is required if the `EntityId` field is provided.")] = None,
        statuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any users whose lease is in one of the provided statuses.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RetailCashUserMessage]]:
        """Retrieve all retail cash users
    ...
    @validate_call
    async def external_api_retail_cash_read_get_retail_cash_users_without_preload_content(
        self,
        entityid: Annotated[Optional[StrictInt], Field(description="Filters results to any users associated with the specified entity id value. The value must be of the type specified in the `EntityType` field.")] = None,
        entitytype: Annotated[Optional[StrictStr], Field(description="Specifies the type of entity that the `EntityId` field refers to. This field is required if the `EntityId` field is provided.")] = None,
        statuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any users whose lease is in one of the provided statuses.")] = None,
    ...
    def _external_api_retail_cash_read_get_retail_cash_users_serialize(
        self,
        entityid,
        entitytype,
        statuses,
        ...
        if unitaddress is not None:
            ...
            _query_params.append(('unitaddress', unitaddress))
            
        if isaccountcreated is not None:
            
            _query_params.append(('isaccountcreated', isaccountcreated))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/retailcashusers',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_retail_cash_write_update_retail_cash_user(
        self,
        user_id: StrictInt,
        unit_agreement_id: StrictInt,
        retail_cash_user_put_message: RetailCashUserPutMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param unit_agreement_id: (required)
        :type unit_agreement_id: int
        :param retail_cash_user_put_message: (required)
        :type retail_cash_user_put_message: RetailCashUserPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_retail_cash_write_update_retail_cash_user_serialize(
            user_id=user_id,
            unit_agreement_id=unit_agreement_id,
            retail_cash_user_put_message=retail_cash_user_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_retail_cash_write_update_retail_cash_user_with_http_info(
        self,
        user_id: StrictInt,
        unit_agreement_id: StrictInt,
        retail_cash_user_put_message: RetailCashUserPutMessage,
    ...
    @validate_call
    async def external_api_retail_cash_write_update_retail_cash_user_without_preload_content(
        self,
        user_id: StrictInt,
        unit_agreement_id: StrictInt,
        retail_cash_user_put_message: RetailCashUserPutMessage,
    ...
    def _external_api_retail_cash_write_update_retail_cash_user_serialize(
        self,
        user_id,
        unit_agreement_id,
        retail_cash_user_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if retail_cash_user_put_message is not None:
            _body_params = retail_cash_user_put_message
