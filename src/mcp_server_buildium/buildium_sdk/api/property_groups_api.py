...
class PropertyGroupsApi:
    ...
    @validate_call
    async def external_api_property_groups_create_property_group(
        self,
        property_group_post_message: PropertyGroupPostMessage,
        ...
        :param property_group_post_message: (required)
        :type property_group_post_message: PropertyGroupPostMessage
        ...
        _param = self._external_api_property_groups_create_property_group_serialize(
            property_group_post_message=property_group_post_message,
    ...
    @validate_call
    async def external_api_property_groups_create_property_group_with_http_info(
        self,
        property_group_post_message: PropertyGroupPostMessage,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PropertyGroupMessage]:
        """Create a property group
    ...
    @validate_call
    async def external_api_property_groups_create_property_group_without_preload_content(
        self,
        property_group_post_message: PropertyGroupPostMessage,
        _request_timeout: Union[
            None,
    ...
    def _external_api_property_groups_create_property_group_serialize(
        self,
        property_group_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if property_group_post_message is not None:
            _body_params = property_group_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/propertygroups',
    ...
    @validate_call
    async def external_api_property_groups_get_property_group_by_id(
        self,
        property_group_id: StrictInt,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param property_group_id: (required)
        :type property_group_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_property_groups_get_property_group_by_id_serialize(
    ...
    @validate_call
    async def external_api_property_groups_get_property_group_by_id_with_http_info(
        self,
        property_group_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def external_api_property_groups_get_property_group_by_id_without_preload_content(
        self,
        property_group_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _external_api_property_groups_get_property_group_by_id_serialize(
        self,
        property_group_id,
        _request_auth,
        _content_type,
        ...
        if property_group_id is not None:
            _path_params['propertyGroupId'] = property_group_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/propertygroups/{propertyGroupId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_property_groups_get_property_groups(
        self,
        propertyids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to property groups that contain any of the specified property ids.")] = None,
        nameordescription: Annotated[Optional[StrictStr], Field(description="Filters results to any property group whose name or description contains the specified value.")] = None,
        ...
        :param propertyids: Filters results to property groups that contain any of the specified property ids.
        :type propertyids: List[int]
        :param nameordescription: Filters results to any property group whose name or description contains the specified value.
        :type nameordescription: str
        ...
        _param = self._external_api_property_groups_get_property_groups_serialize(
    ...
    @validate_call
    async def external_api_property_groups_get_property_groups_with_http_info(
        self,
        propertyids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to property groups that contain any of the specified property ids.")] = None,
        nameordescription: Annotated[Optional[StrictStr], Field(description="Filters results to any property group whose name or description contains the specified value.")] = None,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[PropertyGroupMessage]]:
        """Retrieve all property groups
    ...
    @validate_call
    async def external_api_property_groups_get_property_groups_without_preload_content(
        self,
        propertyids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to property groups that contain any of the specified property ids.")] = None,
        nameordescription: Annotated[Optional[StrictStr], Field(description="Filters results to any property group whose name or description contains the specified value.")] = None,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
    ...
    def _external_api_property_groups_get_property_groups_serialize(
        self,
        propertyids,
        nameordescription,
        orderby,
        ...
        if nameordescription is not None:
            
            _query_params.append(('nameordescription', nameordescription))
    ...
    @validate_call
    async def external_api_property_groups_update_property_group(
        self,
        property_group_id: StrictInt,
        ...
        :param property_group_id: (required)
        :type property_group_id: int
        :param property_group_put_message: (required)
        :type property_group_put_message: PropertyGroupPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_property_groups_update_property_group_serialize(
            property_group_id=property_group_id,
            property_group_put_message=property_group_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_property_groups_update_property_group_with_http_info(
        self,
        property_group_id: StrictInt,
        property_group_put_message: PropertyGroupPutMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_property_groups_update_property_group_without_preload_content(
        self,
        property_group_id: StrictInt,
        property_group_put_message: PropertyGroupPutMessage,
        _request_timeout: Union[
    ...
    def _external_api_property_groups_update_property_group_serialize(
        self,
        property_group_id,
        property_group_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if property_group_put_message is not None:
            _body_params = property_group_put_message
