...
from mcp_server_buildium.buildium_sdk.models.rental_owner_contribution_data_put_message import RentalOwnerContributionDataPutMessage
from mcp_server_buildium.buildium_sdk.models.rental_owner_request_task_message import RentalOwnerRequestTaskMessage
from mcp_server_buildium.buildium_sdk.models.rental_owner_request_task_post_message import RentalOwnerRequestTaskPostMessage
from mcp_server_buildium.buildium_sdk.models.rental_owner_request_task_put_message import RentalOwnerRequestTaskPutMessage
...
class RentalOwnerRequestsApi:
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_create_rental_owner_request_task(
        self,
        rental_owner_request_task_post_message: RentalOwnerRequestTaskPostMessage,
        ...
        :param rental_owner_request_task_post_message: (required)
        :type rental_owner_request_task_post_message: RentalOwnerRequestTaskPostMessage
        ...
        _param = self._external_api_rental_owner_request_tasks_create_rental_owner_request_task_serialize(
            rental_owner_request_task_post_message=rental_owner_request_task_post_message,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "RentalOwnerRequestTaskMessage",
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_create_rental_owner_request_task_with_http_info(
        self,
        rental_owner_request_task_post_message: RentalOwnerRequestTaskPostMessage,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RentalOwnerRequestTaskMessage]:
        """Create a rental owner request
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_create_rental_owner_request_task_without_preload_content(
        self,
        rental_owner_request_task_post_message: RentalOwnerRequestTaskPostMessage,
        _request_timeout: Union[
            None,
    ...
    def _external_api_rental_owner_request_tasks_create_rental_owner_request_task_serialize(
        self,
        ...
        if rental_owner_request_task_post_message is not None:
            _body_params = rental_owner_request_task_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/tasks/rentalownerrequests',
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_get_all_rental_owner_request_tasks(
        self,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[RentalOwnerRequestTaskMessage]:
        ...
        _param = self._external_api_rental_owner_request_tasks_get_all_rental_owner_request_tasks_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[RentalOwnerRequestTaskMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '422': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_get_all_rental_owner_request_tasks_with_http_info(
        self,
        entitytype: Annotated[Optional[StrictStr], Field(description="Specifies the type of entity that the `EntityId` field refers to. This field is required if the `EntityId` field is populated.")] = None,
        entityid: Annotated[Optional[StrictInt], Field(description="Filters results to any task associated with the specified entity id value. The value must be of the type specified in the `EntityType` field.")] = None,
        statuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results by the status of the task. If no status is specified, tasks with any status will be returned.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[RentalOwnerRequestTaskMessage]]:
        """Retrieve all rental owner requests
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_get_all_rental_owner_request_tasks_without_preload_content(
        self,
        entitytype: Annotated[Optional[StrictStr], Field(description="Specifies the type of entity that the `EntityId` field refers to. This field is required if the `EntityId` field is populated.")] = None,
        entityid: Annotated[Optional[StrictInt], Field(description="Filters results to any task associated with the specified entity id value. The value must be of the type specified in the `EntityType` field.")] = None,
        statuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results by the status of the task. If no status is specified, tasks with any status will be returned.")] = None,
    ...
    def _external_api_rental_owner_request_tasks_get_all_rental_owner_request_tasks_serialize(
        self,
        entitytype,
        entityid,
        statuses,
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_get_rental_owner_request_task_by_id(
        self,
        rental_owner_request_task_id: Annotated[StrictInt, Field(description="The rental owner request identifier.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param rental_owner_request_task_id: The rental owner request identifier. (required)
        :type rental_owner_request_task_id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_rental_owner_request_tasks_get_rental_owner_request_task_by_id_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RentalOwnerRequestTaskMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_get_rental_owner_request_task_by_id_with_http_info(
        self,
        rental_owner_request_task_id: Annotated[StrictInt, Field(description="The rental owner request identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_get_rental_owner_request_task_by_id_without_preload_content(
        self,
        rental_owner_request_task_id: Annotated[StrictInt, Field(description="The rental owner request identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _external_api_rental_owner_request_tasks_get_rental_owner_request_task_by_id_serialize(
        self,
        rental_owner_request_task_id,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the path parameters
        if rental_owner_request_task_id is not None:
            _path_params['rentalOwnerRequestTaskId'] = rental_owner_request_task_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/tasks/rentalownerrequests/{rentalOwnerRequestTaskId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_get_rental_owner_request_task_contribution_data(
        self,
        rental_owner_request_task_id: Annotated[StrictInt, Field(description="The rental owner request identifier.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._external_api_rental_owner_request_tasks_get_rental_owner_request_task_contribution_data_serialize(
            rental_owner_request_task_id=rental_owner_request_task_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "RentalOwnerContributionDataMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_get_rental_owner_request_task_contribution_data_with_http_info(
        self,
        rental_owner_request_task_id: Annotated[StrictInt, Field(description="The rental owner request identifier.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[RentalOwnerContributionDataMessage]:
        """Retrieve rental owner contribution request
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_get_rental_owner_request_task_contribution_data_without_preload_content(
        self,
        rental_owner_request_task_id: Annotated[StrictInt, Field(description="The rental owner request identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _external_api_rental_owner_request_tasks_get_rental_owner_request_task_contribution_data_serialize(
        self,
        rental_owner_request_task_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/tasks/rentalownerrequests/{rentalOwnerRequestTaskId}/contributiondata',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_update_rental_owner_request_task(
        self,
        rental_owner_request_task_id: Annotated[StrictInt, Field(description="The rental owner request identifier.")],
        ...
        :param rental_owner_request_task_id: The rental owner request identifier. (required)
        :type rental_owner_request_task_id: int
        :param rental_owner_request_task_put_message: (required)
        :type rental_owner_request_task_put_message: RentalOwnerRequestTaskPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_rental_owner_request_tasks_update_rental_owner_request_task_serialize(
            rental_owner_request_task_id=rental_owner_request_task_id,
            rental_owner_request_task_put_message=rental_owner_request_task_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_update_rental_owner_request_task_with_http_info(
        self,
        rental_owner_request_task_id: Annotated[StrictInt, Field(description="The rental owner request identifier.")],
        rental_owner_request_task_put_message: RentalOwnerRequestTaskPutMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_update_rental_owner_request_task_without_preload_content(
        self,
        rental_owner_request_task_id: Annotated[StrictInt, Field(description="The rental owner request identifier.")],
        rental_owner_request_task_put_message: RentalOwnerRequestTaskPutMessage,
        _request_timeout: Union[
    ...
    def _external_api_rental_owner_request_tasks_update_rental_owner_request_task_serialize(
        self,
        rental_owner_request_task_id,
        rental_owner_request_task_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if rental_owner_request_task_put_message is not None:
            _body_params = rental_owner_request_task_put_message
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_update_rental_owner_request_task_contribution_data(
        self,
        rental_owner_request_task_id: Annotated[StrictInt, Field(description="The rental owner request identifier.")],
        ...
        :param rental_owner_request_task_id: The rental owner request identifier. (required)
        :type rental_owner_request_task_id: int
        :param rental_owner_contribution_data_put_message: (required)
        :type rental_owner_contribution_data_put_message: RentalOwnerContributionDataPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_rental_owner_request_tasks_update_rental_owner_request_task_contribution_data_serialize(
            rental_owner_request_task_id=rental_owner_request_task_id,
            rental_owner_contribution_data_put_message=rental_owner_contribution_data_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_update_rental_owner_request_task_contribution_data_with_http_info(
        self,
        rental_owner_request_task_id: Annotated[StrictInt, Field(description="The rental owner request identifier.")],
        rental_owner_contribution_data_put_message: RentalOwnerContributionDataPutMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_rental_owner_request_tasks_update_rental_owner_request_task_contribution_data_without_preload_content(
        self,
        rental_owner_request_task_id: Annotated[StrictInt, Field(description="The rental owner request identifier.")],
        rental_owner_contribution_data_put_message: RentalOwnerContributionDataPutMessage,
        _request_timeout: Union[
    ...
    def _external_api_rental_owner_request_tasks_update_rental_owner_request_task_contribution_data_serialize(
        self,
        rental_owner_request_task_id,
        rental_owner_contribution_data_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if rental_owner_contribution_data_put_message is not None:
            _body_params = rental_owner_contribution_data_put_message
