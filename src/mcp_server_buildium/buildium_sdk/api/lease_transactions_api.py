...
from typing_extensions import Annotated
from mcp_server_buildium.buildium_sdk.models.bulk_lease_recurring_transaction_message import BulkLeaseRecurringTransactionMessage
...
from mcp_server_buildium.buildium_sdk.models.lease_charge_message import LeaseChargeMessage
from mcp_server_buildium.buildium_sdk.models.lease_charge_post_message import LeaseChargePostMessage
from mcp_server_buildium.buildium_sdk.models.lease_charge_put_message import LeaseChargePutMessage
from mcp_server_buildium.buildium_sdk.models.lease_charge_recurring_transaction_message import LeaseChargeRecurringTransactionMessage
from mcp_server_buildium.buildium_sdk.models.lease_ledger_credit_post_message import LeaseLedgerCreditPostMessage
from mcp_server_buildium.buildium_sdk.models.lease_ledger_deposit_withholding_post_message import LeaseLedgerDepositWithholdingPostMessage
from mcp_server_buildium.buildium_sdk.models.lease_ledger_deposit_withholding_put_message import LeaseLedgerDepositWithholdingPutMessage
from mcp_server_buildium.buildium_sdk.models.lease_ledger_payment_post_message import LeaseLedgerPaymentPostMessage
from mcp_server_buildium.buildium_sdk.models.lease_ledger_payment_put_message import LeaseLedgerPaymentPutMessage
from mcp_server_buildium.buildium_sdk.models.lease_ledger_refund_message import LeaseLedgerRefundMessage
from mcp_server_buildium.buildium_sdk.models.lease_ledger_refund_post_message import LeaseLedgerRefundPostMessage
from mcp_server_buildium.buildium_sdk.models.lease_ledger_reverse_payment_post_message import LeaseLedgerReversePaymentPostMessage
from mcp_server_buildium.buildium_sdk.models.lease_outstanding_balance_message import LeaseOutstandingBalanceMessage
from mcp_server_buildium.buildium_sdk.models.lease_recurring_credit_message import LeaseRecurringCreditMessage
...
class LeaseTransactionsApi:
    ...
    @validate_call
    async def external_api_lease_auto_allocated_payment_create_lease_auto_allocated_payment(
        self,
        lease_id: StrictInt,
        lease_auto_allocated_payment_post_message: LeaseAutoAllocatedPaymentPostMessage,
        ...
        :type lease_id: int
        :param lease_auto_allocated_payment_post_message: (required)
        :type lease_auto_allocated_payment_post_message: LeaseAutoAllocatedPaymentPostMessage
        ...
        _param = self._external_api_lease_auto_allocated_payment_create_lease_auto_allocated_payment_serialize(
            lease_id=lease_id,
            lease_auto_allocated_payment_post_message=lease_auto_allocated_payment_post_message,
    ...
    @validate_call
    async def external_api_lease_auto_allocated_payment_create_lease_auto_allocated_payment_with_http_info(
        self,
        lease_id: StrictInt,
        lease_auto_allocated_payment_post_message: LeaseAutoAllocatedPaymentPostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LeaseTransactionMessage]:
        """Create a payment (auto allocated)
    ...
    @validate_call
    async def external_api_lease_auto_allocated_payment_create_lease_auto_allocated_payment_without_preload_content(
        self,
        lease_id: StrictInt,
        lease_auto_allocated_payment_post_message: LeaseAutoAllocatedPaymentPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_lease_auto_allocated_payment_create_lease_auto_allocated_payment_serialize(
        self,
        lease_id,
        lease_auto_allocated_payment_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if lease_auto_allocated_payment_post_message is not None:
            _body_params = lease_auto_allocated_payment_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/leases/{leaseId}/autoallocatedpayments',
    ...
    @validate_call
    async def external_api_lease_charge_recurring_transactions_create_lease_charge_recurring_transaction(
        self,
        lease_id: StrictInt,
        ...
        _param = self._external_api_lease_charge_recurring_transactions_create_lease_charge_recurring_transaction_serialize(
            lease_id=lease_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "LeaseChargeRecurringTransactionMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_lease_charge_recurring_transactions_create_lease_charge_recurring_transaction_with_http_info(
        self,
        lease_id: StrictInt,
        charge_recurring_transaction_post_message: ChargeRecurringTransactionPostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LeaseChargeRecurringTransactionMessage]:
        """Create a recurring charge
    ...
    @validate_call
    async def external_api_lease_charge_recurring_transactions_create_lease_charge_recurring_transaction_without_preload_content(
        self,
        lease_id: StrictInt,
        charge_recurring_transaction_post_message: ChargeRecurringTransactionPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_lease_charge_recurring_transactions_create_lease_charge_recurring_transaction_serialize(
        self,
        lease_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/leases/{leaseId}/recurringcharges',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_charge_recurring_transactions_get_lease_charge_recurring_transaction_by_id(
        self,
        lease_id: StrictInt,
        ...
        _param = self._external_api_lease_charge_recurring_transactions_get_lease_charge_recurring_transaction_by_id_serialize(
            lease_id=lease_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "LeaseChargeRecurringTransactionMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_lease_charge_recurring_transactions_get_lease_charge_recurring_transaction_by_id_with_http_info(
        self,
        lease_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_lease_charge_recurring_transactions_get_lease_charge_recurring_transaction_by_id_without_preload_content(
        self,
        lease_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_lease_charge_recurring_transactions_get_lease_charge_recurring_transaction_by_id_serialize(
        self,
        lease_id,
        transaction_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/leases/{leaseId}/recurringcharges/{transactionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def external_api_lease_ledger_charges_read_get_all_charges(
        ...
        _param = self._external_api_lease_ledger_charges_read_get_all_charges_serialize(
            lease_id=lease_id,
    ...
    @validate_call
    async def external_api_lease_ledger_charges_read_get_all_charges_with_http_info(
        self,
        lease_id: StrictInt,
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose start date is greater than or equal to the specified value.")] = None,
        transactiondateto: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose end date is less than or equal to the specified value.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[LeaseChargeMessage]]:
        """Retrieve all charges
    ...
    @validate_call
    async def external_api_lease_ledger_charges_read_get_all_charges_without_preload_content(
        self,
        lease_id: StrictInt,
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose start date is greater than or equal to the specified value.")] = None,
        transactiondateto: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose end date is less than or equal to the specified value.")] = None,
    ...
    def _external_api_lease_ledger_charges_read_get_all_charges_serialize(
        self,
        lease_id,
        transactiondatefrom,
        transactiondateto,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/leases/{leaseId}/charges',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_ledger_charges_read_get_charge_by_id(
        self,
        lease_id: StrictInt,
        charge_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_lease_ledger_charges_read_get_charge_by_id_serialize(
            lease_id=lease_id,
            charge_id=charge_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def external_api_lease_ledger_charges_read_get_charge_by_id_with_http_info(
        self,
        lease_id: StrictInt,
        charge_id: StrictInt,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LeaseChargeMessage]:
        """Retrieve a charge
    ...
    @validate_call
    async def external_api_lease_ledger_charges_read_get_charge_by_id_without_preload_content(
        self,
        lease_id: StrictInt,
        charge_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_lease_ledger_charges_read_get_charge_by_id_serialize(
        self,
        lease_id,
        charge_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/leases/{leaseId}/charges/{chargeId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def external_api_lease_ledger_charges_write_create_charge(
        ...
        :param lease_id: (required)
        :type lease_id: int
        :param lease_charge_post_message: (required)
        :type lease_charge_post_message: LeaseChargePostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_lease_ledger_charges_write_create_charge_serialize(
            lease_id=lease_id,
            lease_charge_post_message=lease_charge_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "List[LeaseTransactionMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_lease_ledger_charges_write_create_charge_with_http_info(
        self,
        lease_id: StrictInt,
        lease_charge_post_message: LeaseChargePostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[LeaseTransactionMessage]]:
        """Create a charge
    ...
    @validate_call
    async def external_api_lease_ledger_charges_write_create_charge_without_preload_content(
        self,
        lease_id: StrictInt,
        lease_charge_post_message: LeaseChargePostMessage,
        _request_timeout: Union[
    ...
    def _external_api_lease_ledger_charges_write_create_charge_serialize(
        self,
        lease_id,
        ...
        # process the form parameters
        # process the body parameter
        if lease_charge_post_message is not None:
            _body_params = lease_charge_post_message
    ...
    @validate_call
    async def external_api_lease_ledger_charges_write_update_lease_charge(
        self,
        lease_id: StrictInt,
        charge_id: StrictInt,
        ...
        :param charge_id: (required)
        :type charge_id: int
        :param lease_charge_put_message: (required)
        :type lease_charge_put_message: LeaseChargePutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_lease_ledger_charges_write_update_lease_charge_serialize(
            lease_id=lease_id,
            charge_id=charge_id,
            lease_charge_put_message=lease_charge_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_lease_ledger_charges_write_update_lease_charge_with_http_info(
        self,
        lease_id: StrictInt,
        charge_id: StrictInt,
        lease_charge_put_message: LeaseChargePutMessage,
    ...
    @validate_call
    async def external_api_lease_ledger_charges_write_update_lease_charge_without_preload_content(
        self,
        lease_id: StrictInt,
        charge_id: StrictInt,
        lease_charge_put_message: LeaseChargePutMessage,
    ...
    def _external_api_lease_ledger_charges_write_update_lease_charge_serialize(
        self,
        lease_id,
        charge_id,
        lease_charge_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if lease_charge_put_message is not None:
            _body_params = lease_charge_put_message
    ...
    @validate_call
    async def external_api_lease_ledger_credits_write_create_lease_credit(
        self,
        lease_id: Annotated[StrictInt, Field(description="The lease unique identifier.")],
        ...
        :param lease_id: The lease unique identifier. (required)
        :type lease_id: int
        :param lease_ledger_credit_post_message: (required)
        :type lease_ledger_credit_post_message: LeaseLedgerCreditPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_lease_ledger_credits_write_create_lease_credit_serialize(
            lease_id=lease_id,
            lease_ledger_credit_post_message=lease_ledger_credit_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_lease_ledger_credits_write_create_lease_credit_with_http_info(
        self,
        lease_id: Annotated[StrictInt, Field(description="The lease unique identifier.")],
        lease_ledger_credit_post_message: LeaseLedgerCreditPostMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_lease_ledger_credits_write_create_lease_credit_without_preload_content(
        self,
        lease_id: Annotated[StrictInt, Field(description="The lease unique identifier.")],
        lease_ledger_credit_post_message: LeaseLedgerCreditPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_lease_ledger_credits_write_create_lease_credit_serialize(
        self,
        lease_id,
        ...
        # process the form parameters
        # process the body parameter
        if lease_ledger_credit_post_message is not None:
            _body_params = lease_ledger_credit_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/leases/{leaseId}/credits',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_ledger_deposit_withholding_create_lease_ledger_deposit_withholding(
        self,
        lease_id: StrictInt,
        ...
        :param lease_id: (required)
        :type lease_id: int
        :param lease_ledger_deposit_withholding_post_message: (required)
        :type lease_ledger_deposit_withholding_post_message: LeaseLedgerDepositWithholdingPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_lease_ledger_deposit_withholding_create_lease_ledger_deposit_withholding_serialize(
            lease_id=lease_id,
            lease_ledger_deposit_withholding_post_message=lease_ledger_deposit_withholding_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_lease_ledger_deposit_withholding_create_lease_ledger_deposit_withholding_with_http_info(
        self,
        lease_id: StrictInt,
        lease_ledger_deposit_withholding_post_message: LeaseLedgerDepositWithholdingPostMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_lease_ledger_deposit_withholding_create_lease_ledger_deposit_withholding_without_preload_content(
        self,
        lease_id: StrictInt,
        lease_ledger_deposit_withholding_post_message: LeaseLedgerDepositWithholdingPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_lease_ledger_deposit_withholding_create_lease_ledger_deposit_withholding_serialize(
        self,
        lease_id,
        lease_ledger_deposit_withholding_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if lease_ledger_deposit_withholding_post_message is not None:
            _body_params = lease_ledger_deposit_withholding_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/leases/{leaseId}/applieddeposits',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_ledger_deposit_withholding_update_deposit_withholding(
        self,
        lease_id: StrictInt,
        deposit_id: StrictInt,
        lease_ledger_deposit_withholding_put_message: LeaseLedgerDepositWithholdingPutMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type deposit_id: int
        :param lease_ledger_deposit_withholding_put_message: (required)
        :type lease_ledger_deposit_withholding_put_message: LeaseLedgerDepositWithholdingPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_lease_ledger_deposit_withholding_update_deposit_withholding_serialize(
            lease_id=lease_id,
            deposit_id=deposit_id,
            lease_ledger_deposit_withholding_put_message=lease_ledger_deposit_withholding_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_lease_ledger_deposit_withholding_update_deposit_withholding_with_http_info(
        self,
        lease_id: StrictInt,
        deposit_id: StrictInt,
        lease_ledger_deposit_withholding_put_message: LeaseLedgerDepositWithholdingPutMessage,
    ...
    @validate_call
    async def external_api_lease_ledger_deposit_withholding_update_deposit_withholding_without_preload_content(
        self,
        lease_id: StrictInt,
        deposit_id: StrictInt,
        lease_ledger_deposit_withholding_put_message: LeaseLedgerDepositWithholdingPutMessage,
    ...
    def _external_api_lease_ledger_deposit_withholding_update_deposit_withholding_serialize(
        self,
        lease_id,
        deposit_id,
        lease_ledger_deposit_withholding_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if lease_ledger_deposit_withholding_put_message is not None:
            _body_params = lease_ledger_deposit_withholding_put_message
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/leases/{leaseId}/applieddeposits/{depositId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_ledger_payment_reversals_write_create_lease_reverse_payment(
        self,
        lease_id: Annotated[StrictInt, Field(description="The lease unique identifier.")],
        ...
        :param lease_id: The lease unique identifier. (required)
        :type lease_id: int
        :param lease_ledger_reverse_payment_post_message: (required)
        :type lease_ledger_reverse_payment_post_message: LeaseLedgerReversePaymentPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_lease_ledger_payment_reversals_write_create_lease_reverse_payment_serialize(
            lease_id=lease_id,
            lease_ledger_reverse_payment_post_message=lease_ledger_reverse_payment_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_lease_ledger_payment_reversals_write_create_lease_reverse_payment_with_http_info(
        self,
        lease_id: Annotated[StrictInt, Field(description="The lease unique identifier.")],
        lease_ledger_reverse_payment_post_message: LeaseLedgerReversePaymentPostMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_lease_ledger_payment_reversals_write_create_lease_reverse_payment_without_preload_content(
        self,
        lease_id: Annotated[StrictInt, Field(description="The lease unique identifier.")],
        lease_ledger_reverse_payment_post_message: LeaseLedgerReversePaymentPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_lease_ledger_payment_reversals_write_create_lease_reverse_payment_serialize(
        self,
        lease_id,
        lease_ledger_reverse_payment_post_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if lease_ledger_reverse_payment_post_message is not None:
            _body_params = lease_ledger_reverse_payment_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/leases/{leaseId}/reversepayments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_ledger_payments_write_create_payment(
        self,
        lease_id: Annotated[StrictInt, Field(description="The lease unique identifier.")],
        ...
        :param lease_id: The lease unique identifier. (required)
        :type lease_id: int
        :param lease_ledger_payment_post_message: (required)
        :type lease_ledger_payment_post_message: LeaseLedgerPaymentPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_lease_ledger_payments_write_create_payment_serialize(
            lease_id=lease_id,
            lease_ledger_payment_post_message=lease_ledger_payment_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_lease_ledger_payments_write_create_payment_with_http_info(
        self,
        lease_id: Annotated[StrictInt, Field(description="The lease unique identifier.")],
        lease_ledger_payment_post_message: LeaseLedgerPaymentPostMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_lease_ledger_payments_write_create_payment_without_preload_content(
        self,
        lease_id: Annotated[StrictInt, Field(description="The lease unique identifier.")],
        lease_ledger_payment_post_message: LeaseLedgerPaymentPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_lease_ledger_payments_write_create_payment_serialize(
        self,
        lease_id,
        ...
        # process the form parameters
        # process the body parameter
        if lease_ledger_payment_post_message is not None:
            _body_params = lease_ledger_payment_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/leases/{leaseId}/payments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_ledger_payments_write_update_lease_ledger_payment(
        self,
        lease_id: StrictInt,
        ...
        :type payment_id: int
        :param lease_ledger_payment_put_message: (required)
        :type lease_ledger_payment_put_message: LeaseLedgerPaymentPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_lease_ledger_payments_write_update_lease_ledger_payment_serialize(
            lease_id=lease_id,
            payment_id=payment_id,
            lease_ledger_payment_put_message=lease_ledger_payment_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_lease_ledger_payments_write_update_lease_ledger_payment_with_http_info(
        self,
        lease_id: StrictInt,
        payment_id: StrictInt,
        lease_ledger_payment_put_message: LeaseLedgerPaymentPutMessage,
    ...
    @validate_call
    async def external_api_lease_ledger_payments_write_update_lease_ledger_payment_without_preload_content(
        self,
        lease_id: StrictInt,
        payment_id: StrictInt,
        lease_ledger_payment_put_message: LeaseLedgerPaymentPutMessage,
    ...
    def _external_api_lease_ledger_payments_write_update_lease_ledger_payment_serialize(
        self,
        lease_id,
        payment_id,
        lease_ledger_payment_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if lease_ledger_payment_put_message is not None:
            _body_params = lease_ledger_payment_put_message
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1/leases/{leaseId}/payments/{paymentId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_ledger_refunds_create_lease_ledger_refund(
        self,
        lease_id: StrictInt,
        ...
        :param lease_id: (required)
        :type lease_id: int
        :param lease_ledger_refund_post_message: (required)
        :type lease_ledger_refund_post_message: LeaseLedgerRefundPostMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_lease_ledger_refunds_create_lease_ledger_refund_serialize(
            lease_id=lease_id,
            lease_ledger_refund_post_message=lease_ledger_refund_post_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_lease_ledger_refunds_create_lease_ledger_refund_with_http_info(
        self,
        lease_id: StrictInt,
        lease_ledger_refund_post_message: LeaseLedgerRefundPostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LeaseLedgerRefundMessage]:
        """Create a refund
    ...
    @validate_call
    async def external_api_lease_ledger_refunds_create_lease_ledger_refund_without_preload_content(
        self,
        lease_id: StrictInt,
        lease_ledger_refund_post_message: LeaseLedgerRefundPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_lease_ledger_refunds_create_lease_ledger_refund_serialize(
        self,
        lease_id,
        ...
        # process the form parameters
        # process the body parameter
        if lease_ledger_refund_post_message is not None:
            _body_params = lease_ledger_refund_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/leases/{leaseId}/refunds',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_ledger_refunds_get_lease_ledger_refund_by_id(
        self,
        lease_id: StrictInt,
        refund_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_lease_ledger_refunds_get_lease_ledger_refund_by_id_serialize(
            lease_id=lease_id,
            refund_id=refund_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def external_api_lease_ledger_refunds_get_lease_ledger_refund_by_id_with_http_info(
        self,
        lease_id: StrictInt,
        refund_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_lease_ledger_refunds_get_lease_ledger_refund_by_id_without_preload_content(
        self,
        lease_id: StrictInt,
        refund_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_lease_ledger_refunds_get_lease_ledger_refund_by_id_serialize(
        self,
        lease_id,
        refund_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/leases/{leaseId}/refunds/{refundId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_ledger_transactions_get_lease_ledger_transaction_by_id(
        self,
        lease_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_lease_ledger_transactions_get_lease_ledger_transaction_by_id_serialize(
            lease_id=lease_id,
            transaction_id=transaction_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def external_api_lease_ledger_transactions_get_lease_ledger_transaction_by_id_with_http_info(
        self,
        lease_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_lease_ledger_transactions_get_lease_ledger_transaction_by_id_without_preload_content(
        self,
        lease_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_lease_ledger_transactions_get_lease_ledger_transaction_by_id_serialize(
        self,
        lease_id,
        transaction_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/leases/{leaseId}/transactions/{transactionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def external_api_lease_ledger_transactions_get_lease_ledgers(
        ...
        _param = self._external_api_lease_ledger_transactions_get_lease_ledgers_serialize(
            lease_id=lease_id,
            transactiondatefrom=transactiondatefrom,
            transactiondateto=transactiondateto,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[LeaseTransactionMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_lease_ledger_transactions_get_lease_ledgers_with_http_info(
        self,
        lease_id: StrictInt,
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose start date is greater than or equal to the specified value.")] = None,
        transactiondateto: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose end date is less than or equal to the specified value.")] = None,
    ...
    @validate_call
    async def external_api_lease_ledger_transactions_get_lease_ledgers_without_preload_content(
        self,
        lease_id: StrictInt,
        transactiondatefrom: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose start date is greater than or equal to the specified value.")] = None,
        transactiondateto: Annotated[Optional[date], Field(description="Filters results to any lease transaction whose end date is less than or equal to the specified value.")] = None,
    ...
    def _external_api_lease_ledger_transactions_get_lease_ledgers_serialize(
        self,
        lease_id,
        transactiondatefrom,
        transactiondateto,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/leases/{leaseId}/transactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def external_api_lease_outstanding_balances_get_lease_outstanding_balances(
        self,
        entitytype: Optional[StrictStr] = None,
        entityid: Optional[StrictInt] = None,
        leasestatuses: Optional[List[StrictStr]] = None,
        leaseids: Optional[List[StrictInt]] = None,
        pastdueemail: Optional[StrictStr] = None,
        balanceduration: Optional[StrictStr] = None,
        evictionstatus: Optional[StrictStr] = None,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="`limit` indicates the maximum number of results to be returned in the response. `limit` can range between 1 and 1000 and the default is 50.")] = None,
        _request_timeout: Union[
        ...
        _param = self._external_api_lease_outstanding_balances_get_lease_outstanding_balances_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[LeaseOutstandingBalanceMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '422': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_lease_outstanding_balances_get_lease_outstanding_balances_with_http_info(
        self,
        entitytype: Optional[StrictStr] = None,
        entityid: Optional[StrictInt] = None,
        leasestatuses: Optional[List[StrictStr]] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[LeaseOutstandingBalanceMessage]]:
        """Retrieve all outstanding balances
    ...
    @validate_call
    async def external_api_lease_outstanding_balances_get_lease_outstanding_balances_without_preload_content(
        self,
        entitytype: Optional[StrictStr] = None,
        entityid: Optional[StrictInt] = None,
        leasestatuses: Optional[List[StrictStr]] = None,
    ...
    def _external_api_lease_outstanding_balances_get_lease_outstanding_balances_serialize(
        self,
        entitytype,
        entityid,
        leasestatuses,
        ...
        if leaseids is not None:
            
            _query_params.append(('leaseids', leaseids))
        ...
        if evictionstatus is not None:
            
            _query_params.append(('evictionstatus', evictionstatus))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/leases/outstandingbalances',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_recurring_credits_create_lease_credit_recurring_transaction(
        self,
        lease_id: StrictInt,
        ...
        _param = self._external_api_lease_recurring_credits_create_lease_credit_recurring_transaction_serialize(
            lease_id=lease_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "LeaseRecurringCreditMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_lease_recurring_credits_create_lease_credit_recurring_transaction_with_http_info(
        self,
        lease_id: StrictInt,
        credit_recurring_transaction_post_message: CreditRecurringTransactionPostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LeaseRecurringCreditMessage]:
        """Create a recurring credit
    ...
    @validate_call
    async def external_api_lease_recurring_credits_create_lease_credit_recurring_transaction_without_preload_content(
        self,
        lease_id: StrictInt,
        credit_recurring_transaction_post_message: CreditRecurringTransactionPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_lease_recurring_credits_create_lease_credit_recurring_transaction_serialize(
        self,
        lease_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/leases/{leaseId}/recurringcredits',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_recurring_credits_get_lease_recurring_credit_by_id(
        self,
        lease_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_lease_recurring_credits_get_lease_recurring_credit_by_id_serialize(
            lease_id=lease_id,
            transaction_id=transaction_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "LeaseRecurringCreditMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_lease_recurring_credits_get_lease_recurring_credit_by_id_with_http_info(
        self,
        lease_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_lease_recurring_credits_get_lease_recurring_credit_by_id_without_preload_content(
        self,
        lease_id: StrictInt,
        transaction_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_lease_recurring_credits_get_lease_recurring_credit_by_id_serialize(
        self,
        lease_id,
        transaction_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/leases/{leaseId}/recurringcredits/{transactionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_recurring_payments_create_lease_recurring_payment(
        self,
        lease_id: StrictInt,
        ...
        _param = self._external_api_lease_recurring_payments_create_lease_recurring_payment_serialize(
            lease_id=lease_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "LeaseRecurringPaymentMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_lease_recurring_payments_create_lease_recurring_payment_with_http_info(
        self,
        lease_id: StrictInt,
        payment_recurring_transaction_post_message: PaymentRecurringTransactionPostMessage,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LeaseRecurringPaymentMessage]:
        """Create a recurring payment
    ...
    @validate_call
    async def external_api_lease_recurring_payments_create_lease_recurring_payment_without_preload_content(
        self,
        lease_id: StrictInt,
        payment_recurring_transaction_post_message: PaymentRecurringTransactionPostMessage,
        _request_timeout: Union[
    ...
    def _external_api_lease_recurring_payments_create_lease_recurring_payment_serialize(
        self,
        lease_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/leases/{leaseId}/recurringpayments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_recurring_payments_get_recurring_lease_payments_by_id(
        self,
        lease_id: StrictInt,
        payment_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_lease_recurring_payments_get_recurring_lease_payments_by_id_serialize(
            lease_id=lease_id,
            payment_id=payment_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "LeaseRecurringPaymentMessage",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '404': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_lease_recurring_payments_get_recurring_lease_payments_by_id_with_http_info(
        self,
        lease_id: StrictInt,
        payment_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_lease_recurring_payments_get_recurring_lease_payments_by_id_without_preload_content(
        self,
        lease_id: StrictInt,
        payment_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_lease_recurring_payments_get_recurring_lease_payments_by_id_serialize(
        self,
        lease_id,
        payment_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/leases/{leaseId}/recurringpayments/{paymentId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_recurring_transactions_get_lease_recurring_transactions(
        self,
        lease_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
        ...
        _param = self._external_api_lease_recurring_transactions_get_lease_recurring_transactions_serialize(
            lease_id=lease_id,
            orderby=orderby,
            offset=offset,
            limit=limit,
    ...
    @validate_call
    async def external_api_lease_recurring_transactions_get_lease_recurring_transactions_with_http_info(
        self,
        lease_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
    ...
    @validate_call
    async def external_api_lease_recurring_transactions_get_lease_recurring_transactions_without_preload_content(
        self,
        lease_id: StrictInt,
        orderby: Annotated[Optional[StrictStr], Field(description="`orderby` indicates the field(s) and direction to sort the results in the response. See <a href=\"#section/API-Overview/Bulk-Request-Options\">Bulk Request Options</a> for more information.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="`offset` indicates the position of the first record to return. The `offset` is zero-based and the default is 0.")] = None,
    ...
    def _external_api_lease_recurring_transactions_get_lease_recurring_transactions_serialize(
        self,
        lease_id,
        orderby,
        offset,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/leases/{leaseId}/recurringtransactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_lease_recurring_transactions_get_recurring_transactions_for_all_leases(
        self,
        leaseids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to only include records associated with the provided lease Ids.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> List[BulkLeaseRecurringTransactionMessage]:
        ...
        :param leaseids: Filters results to only include records associated with the provided lease Ids.
        :type leaseids: List[int]
        ...
        _param = self._external_api_lease_recurring_transactions_get_recurring_transactions_for_all_leases_serialize(
            leaseids=leaseids,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "List[BulkLeaseRecurringTransactionMessage]",
            '400': "ApiErrorResponse",
            '401': "ApiErrorResponse",
            '403': "ApiErrorResponse",
            '422': "ApiErrorResponse",
    ...
    @validate_call
    async def external_api_lease_recurring_transactions_get_recurring_transactions_for_all_leases_with_http_info(
        self,
        leaseids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to only include records associated with the provided lease Ids.")] = None,
        createddatetimefrom: Annotated[Optional[datetime], Field(description="Filters results to recurring transactions created after the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.")] = None,
        createddatetimeto: Annotated[Optional[datetime], Field(description="Filters results to recurring transactions created before the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[BulkLeaseRecurringTransactionMessage]]:
        """Retrieve all recurring transactions for all leases
    ...
    @validate_call
    async def external_api_lease_recurring_transactions_get_recurring_transactions_for_all_leases_without_preload_content(
        self,
        leaseids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to only include records associated with the provided lease Ids.")] = None,
        createddatetimefrom: Annotated[Optional[datetime], Field(description="Filters results to recurring transactions created after the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.")] = None,
        createddatetimeto: Annotated[Optional[datetime], Field(description="Filters results to recurring transactions created before the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS. The maximum date range is 365 days.")] = None,
    ...
    def _external_api_lease_recurring_transactions_get_recurring_transactions_for_all_leases_serialize(
        self,
        leaseids,
        createddatetimefrom,
        createddatetimeto,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/leases/recurringtransactions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
