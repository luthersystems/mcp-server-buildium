...
class BudgetsApi:
    ...
    @validate_call
    async def external_api_budgets_create_budget_async(
        self,
        ...
        _param = self._external_api_budgets_create_budget_async_serialize(
    ...
    @validate_call
    async def external_api_budgets_create_budget_async_with_http_info(
        self,
        budget_post_message: BudgetPostMessage,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def external_api_budgets_create_budget_async_without_preload_content(
        self,
        budget_post_message: BudgetPostMessage,
        _request_timeout: Union[
            None,
    ...
    def _external_api_budgets_create_budget_async_serialize(
        self,
        budget_post_message,
        _request_auth,
        _content_type,
    ...
    @validate_call
    async def external_api_budgets_get_budget_by_id(
        self,
        budget_id: StrictInt,
        _request_timeout: Union[
            None,
        ...
        _param = self._external_api_budgets_get_budget_by_id_serialize(
            budget_id=budget_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def external_api_budgets_get_budget_by_id_with_http_info(
        self,
        budget_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def external_api_budgets_get_budget_by_id_without_preload_content(
        self,
        budget_id: StrictInt,
        _request_timeout: Union[
            None,
    ...
    def _external_api_budgets_get_budget_by_id_serialize(
        self,
        budget_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    async def external_api_budgets_get_budgets(
        self,
        ...
        _param = self._external_api_budgets_get_budgets_serialize(
    ...
    @validate_call
    async def external_api_budgets_get_budgets_with_http_info(
        self,
        propertyids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to any budget associated to any of the specified set of property ids.")] = None,
        fiscalyear: Annotated[Optional[StrictInt], Field(description="Filters results to any budgets that end in the given fiscal year. FiscalYear must be a positive number.")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Filters results to any budgets whose name *contains* the specified value.")] = None,
    ...
    @validate_call
    async def external_api_budgets_get_budgets_without_preload_content(
        self,
        propertyids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to any budget associated to any of the specified set of property ids.")] = None,
        fiscalyear: Annotated[Optional[StrictInt], Field(description="Filters results to any budgets that end in the given fiscal year. FiscalYear must be a positive number.")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Filters results to any budgets whose name *contains* the specified value.")] = None,
    ...
    def _external_api_budgets_get_budgets_serialize(
        self,
        propertyids,
        fiscalyear,
        name,
    ...
    @validate_call
    async def external_api_budgets_update_budget(
        self,
        budget_id: StrictInt,
        ...
        _param = self._external_api_budgets_update_budget_serialize(
            budget_id=budget_id,
    ...
    @validate_call
    async def external_api_budgets_update_budget_with_http_info(
        self,
        budget_id: StrictInt,
        budget_put_message: BudgetPutMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_budgets_update_budget_without_preload_content(
        self,
        budget_id: StrictInt,
        budget_put_message: BudgetPutMessage,
        _request_timeout: Union[
    ...
    def _external_api_budgets_update_budget_serialize(
        self,
        budget_id,
        budget_put_message,
        _request_auth,
