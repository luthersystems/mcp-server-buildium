...
class RentalTenantsApi:
    ...
    @validate_call
    async def external_api_rental_tenants_create_rental_tenant(
        self,
        rental_tenant_post_message: RentalTenantPostMessage,
        ...
        :param rental_tenant_post_message: (required)
        :type rental_tenant_post_message: RentalTenantPostMessage
        ...
        _param = self._external_api_rental_tenants_create_rental_tenant_serialize(
            rental_tenant_post_message=rental_tenant_post_message,
    ...
    @validate_call
    async def external_api_rental_tenants_create_rental_tenant_with_http_info(
        self,
        rental_tenant_post_message: RentalTenantPostMessage,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def external_api_rental_tenants_create_rental_tenant_without_preload_content(
        self,
        rental_tenant_post_message: RentalTenantPostMessage,
        _request_timeout: Union[
            None,
    ...
    def _external_api_rental_tenants_create_rental_tenant_serialize(
        self,
        ...
        if rental_tenant_post_message is not None:
            _body_params = rental_tenant_post_message
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/leases/tenants',
    ...
    @validate_call
    async def external_api_rental_tenants_get_all_tenants(
        self,
        buildingstatuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results by the status of the rental property the tenants are associated with. If no status is specified tenants in either `active` and `inactive` rental properties will be returned.")] = None,
        leasetermstatuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any tenant whose lease term matches the specified status.  If no status is specified tenants with any lease terms status will be returned.")] = None,
        unitnumber: Annotated[Optional[StrictStr], Field(description="Filters results to any tenant whose unit number *contains* the specified value.")] = None,
        name: Annotated[Optional[StrictStr], Field(description="Filters results to any tenant whose name *contains* the specified value.")] = None,
        phone: Annotated[Optional[StrictStr], Field(description="Filters results to any tenant whose phone number *contains* the specified value.")] = None,
        email: Annotated[Optional[StrictStr], Field(description="Filters results to any tenant whose email *contains* the specified value.")] = None,
        propertyids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to tenants whose rental unit belongs to the specified set of property ids.")] = None,
        rentalownerids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to tenants whose rental unit belongs to a property with a rental owner in the specified set of rental owner ids.")] = None,
        lastupdatedfrom: Annotated[Optional[datetime], Field(description="Filters results to any rental tenants that were updated on or after the specified date. The value must be in UTC and formatted as YYYY-MM-DDTHH:MM:SSZ.")] = None,
        lastupdatedto: Annotated[Optional[datetime], Field(description="Filters results to any rental tenants that were updated on or before the specified date. The value must be in UTC and formatted as YYYY-MM-DDTHH:MM:SSZ.")] = None,
        unitids: Annotated[Optional[List[StrictInt]], Field(description="Filters results to only tenants associated with the specified set of unit ids.")] = None,
        ...
        :param buildingstatuses: Filters results by the status of the rental property the tenants are associated with. If no status is specified tenants in either `active` and `inactive` rental properties will be returned.
        :type buildingstatuses: List[str]
        :param leasetermstatuses: Filters results to any tenant whose lease term matches the specified status.  If no status is specified tenants with any lease terms status will be returned.
        :type leasetermstatuses: List[str]
        :param unitnumber: Filters results to any tenant whose unit number *contains* the specified value.
        :type unitnumber: str
        :param name: Filters results to any tenant whose name *contains* the specified value.
        :type name: str
        :param phone: Filters results to any tenant whose phone number *contains* the specified value.
        :type phone: str
        :param email: Filters results to any tenant whose email *contains* the specified value.
        :type email: str
        :param propertyids: Filters results to tenants whose rental unit belongs to the specified set of property ids.
        :type propertyids: List[int]
        :param rentalownerids: Filters results to tenants whose rental unit belongs to a property with a rental owner in the specified set of rental owner ids.
        :type rentalownerids: List[int]
        :param lastupdatedfrom: Filters results to any rental tenants that were updated on or after the specified date. The value must be in UTC and formatted as YYYY-MM-DDTHH:MM:SSZ.
        :type lastupdatedfrom: datetime
        :param lastupdatedto: Filters results to any rental tenants that were updated on or before the specified date. The value must be in UTC and formatted as YYYY-MM-DDTHH:MM:SSZ.
        :type lastupdatedto: datetime
        :param unitids: Filters results to only tenants associated with the specified set of unit ids.
        ...
        _param = self._external_api_rental_tenants_get_all_tenants_serialize(
            buildingstatuses=buildingstatuses,
            leasetermstatuses=leasetermstatuses,
    ...
    @validate_call
    async def external_api_rental_tenants_get_all_tenants_with_http_info(
        self,
        buildingstatuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results by the status of the rental property the tenants are associated with. If no status is specified tenants in either `active` and `inactive` rental properties will be returned.")] = None,
        leasetermstatuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any tenant whose lease term matches the specified status.  If no status is specified tenants with any lease terms status will be returned.")] = None,
        unitnumber: Annotated[Optional[StrictStr], Field(description="Filters results to any tenant whose unit number *contains* the specified value.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[TenantMessage]]:
        """Retrieve all tenants
    ...
    @validate_call
    async def external_api_rental_tenants_get_all_tenants_without_preload_content(
        self,
        buildingstatuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results by the status of the rental property the tenants are associated with. If no status is specified tenants in either `active` and `inactive` rental properties will be returned.")] = None,
        leasetermstatuses: Annotated[Optional[List[StrictStr]], Field(description="Filters results to any tenant whose lease term matches the specified status.  If no status is specified tenants with any lease terms status will be returned.")] = None,
        unitnumber: Annotated[Optional[StrictStr], Field(description="Filters results to any tenant whose unit number *contains* the specified value.")] = None,
    ...
    def _external_api_rental_tenants_get_all_tenants_serialize(
        self,
        buildingstatuses,
        leasetermstatuses,
        unitnumber,
        ...
        _collection_formats: Dict[str, str] = {
            'buildingstatuses': 'multi',
            'leasetermstatuses': 'multi',
            'propertyids': 'multi',
        ...
        # process the path parameters
        # process the query parameters
        if buildingstatuses is not None:
            
            _query_params.append(('buildingstatuses', buildingstatuses))
            
        if leasetermstatuses is not None:
            
            _query_params.append(('leasetermstatuses', leasetermstatuses))
    ...
    @validate_call
    async def external_api_rental_tenants_get_tenant_by_id(
        self,
        ...
        _param = self._external_api_rental_tenants_get_tenant_by_id_serialize(
            tenant_id=tenant_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    async def external_api_rental_tenants_get_tenant_by_id_with_http_info(
        self,
        tenant_id: Annotated[StrictInt, Field(description="The tenant identifier.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def external_api_rental_tenants_get_tenant_by_id_without_preload_content(
        self,
        tenant_id: Annotated[StrictInt, Field(description="The tenant identifier.")],
        _request_timeout: Union[
            None,
    ...
    def _external_api_rental_tenants_get_tenant_by_id_serialize(
        self,
        tenant_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/leases/tenants/{tenantId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    async def external_api_rental_tenants_update_rental_tenant(
        self,
        tenant_id: StrictInt,
        rental_tenant_put_message: RentalTenantPutMessage,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type tenant_id: int
        :param rental_tenant_put_message: (required)
        :type rental_tenant_put_message: RentalTenantPutMessage
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._external_api_rental_tenants_update_rental_tenant_serialize(
            tenant_id=tenant_id,
            rental_tenant_put_message=rental_tenant_put_message,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def external_api_rental_tenants_update_rental_tenant_with_http_info(
        self,
        tenant_id: StrictInt,
        rental_tenant_put_message: RentalTenantPutMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_rental_tenants_update_rental_tenant_without_preload_content(
        self,
        tenant_id: StrictInt,
        rental_tenant_put_message: RentalTenantPutMessage,
        _request_timeout: Union[
    ...
    def _external_api_rental_tenants_update_rental_tenant_serialize(
        self,
        tenant_id,
        rental_tenant_put_message,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if rental_tenant_put_message is not None:
            _body_params = rental_tenant_put_message
    ...
    @validate_call
    async def external_api_tenant_notes_create_tenant_note(
        self,
        tenant_id: StrictInt,
        ...
        _param = self._external_api_tenant_notes_create_tenant_note_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    async def external_api_tenant_notes_create_tenant_note_with_http_info(
        self,
        tenant_id: StrictInt,
        note_post_message: NotePostMessage,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_tenant_notes_create_tenant_note_without_preload_content(
        self,
        tenant_id: StrictInt,
        note_post_message: NotePostMessage,
        _request_timeout: Union[
    ...
    def _external_api_tenant_notes_create_tenant_note_serialize(
        self,
        tenant_id,
        note_post_message,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/leases/tenants/{tenantId}/notes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_tenant_notes_get_all_tenant_notes(
        self,
        tenant_id: Annotated[StrictInt, Field(description="The tenant identifier.")],
        ...
        _param = self._external_api_tenant_notes_get_all_tenant_notes_serialize(
            tenant_id=tenant_id,
    ...
    @validate_call
    async def external_api_tenant_notes_get_all_tenant_notes_with_http_info(
        self,
        tenant_id: Annotated[StrictInt, Field(description="The tenant identifier.")],
        updateddatetimefrom: Annotated[Optional[datetime], Field(description="Filters results to any note whose updated date and time are greater than or equal to the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS.")] = None,
        updateddatetimeto: Annotated[Optional[datetime], Field(description="Filters results to any note whose updated date and time are less than or equal to the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS.")] = None,
    ...
    @validate_call
    async def external_api_tenant_notes_get_all_tenant_notes_without_preload_content(
        self,
        tenant_id: Annotated[StrictInt, Field(description="The tenant identifier.")],
        updateddatetimefrom: Annotated[Optional[datetime], Field(description="Filters results to any note whose updated date and time are greater than or equal to the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS.")] = None,
        updateddatetimeto: Annotated[Optional[datetime], Field(description="Filters results to any note whose updated date and time are less than or equal to the specified value. The value must be formatted as YYYY-MM-DD HH:MM:SS.")] = None,
    ...
    def _external_api_tenant_notes_get_all_tenant_notes_serialize(
        self,
        tenant_id,
        updateddatetimefrom,
        updateddatetimeto,
    ...
    @validate_call
    async def external_api_tenant_notes_get_tenant_note_by_id(
        self,
        tenant_id: StrictInt,
        note_id: StrictInt,
        _request_timeout: Union[
        ...
        _param = self._external_api_tenant_notes_get_tenant_note_by_id_serialize(
            tenant_id=tenant_id,
            note_id=note_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    async def external_api_tenant_notes_get_tenant_note_by_id_with_http_info(
        self,
        tenant_id: StrictInt,
        note_id: StrictInt,
        _request_timeout: Union[
    ...
    @validate_call
    async def external_api_tenant_notes_get_tenant_note_by_id_without_preload_content(
        self,
        tenant_id: StrictInt,
        note_id: StrictInt,
        _request_timeout: Union[
    ...
    def _external_api_tenant_notes_get_tenant_note_by_id_serialize(
        self,
        tenant_id,
        note_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/leases/tenants/{tenantId}/notes/{noteId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    async def external_api_tenant_notes_update_lease_tenant_note(
        self,
        tenant_id: StrictInt,
        note_id: StrictInt,
        ...
        _param = self._external_api_tenant_notes_update_lease_tenant_note_serialize(
            tenant_id=tenant_id,
            note_id=note_id,
    ...
    @validate_call
    async def external_api_tenant_notes_update_lease_tenant_note_with_http_info(
        self,
        tenant_id: StrictInt,
        note_id: StrictInt,
        note_put_message: NotePutMessage,
    ...
    @validate_call
    async def external_api_tenant_notes_update_lease_tenant_note_without_preload_content(
        self,
        tenant_id: StrictInt,
        note_id: StrictInt,
        note_put_message: NotePutMessage,
    ...
    def _external_api_tenant_notes_update_lease_tenant_note_serialize(
        self,
        tenant_id,
        note_id,
        note_put_message,
